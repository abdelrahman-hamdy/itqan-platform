...
class QuranIndividualCircleResource extends BaseQuranIndividualCircleResource
{
    ...
    /**
     * Filter circles to current academy only, including soft-deleted.
     */
    ...
    /**
     * Enhanced basic info section with circle_code, description, learning_objectives, is_active.
     */
    ...
    /**
     * Table actions with toggle_status, view_sessions, and soft deletes.
     */
    ...
    /**
     * Table columns with circle code, teacher, student, specialization, is_active.
     */
    ...
    /**
     * Extended filters with teacher, status, and trashed.
     */
