...
class HomeworkSubmissionResource extends BaseAcademicTeacherResource
{
    ...
    /**
     * Override query to show only submissions for Academic teacher's students
     */
    public static function getEloquentQuery(): Builder
    {
        $query = parent::getEloquentQuery();

        // Filter by Academic and Interactive session types
        $query->whereIn('submitable_type', [
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('submitable_type')
                    ->label('نوع الواجب')
                    ->options([
                        'App\\Models\\AcademicSession' => 'أكاديمي',
                        'App\\Models\\InteractiveCourseSession' => 'تفاعلي',
