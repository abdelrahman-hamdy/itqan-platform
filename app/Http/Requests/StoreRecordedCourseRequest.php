...
class StoreRecordedCourseRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'title_en.string' => 'يجب أن يكون عنوان الدورة بالإنجليزية نصاً',
            'title_en.max' => 'يجب ألا يتجاوز عنوان الدورة بالإنجليزية 255 حرفاً',
            'description.required' => 'وصف الدورة مطلوب',
            'description.string' => 'يجب أن يكون وصف الدورة نصاً',
            'description_en.string' => 'يجب أن يكون وصف الدورة بالإنجليزية نصاً',
            ...
            'discount_price.min' => 'يجب ألا يقل سعر الخصم عن 0',
            ...
            'category.string' => 'يجب أن تكون الفئة نصاً',
            'category.max' => 'يجب ألا تتجاوز الفئة 100 حرف',
