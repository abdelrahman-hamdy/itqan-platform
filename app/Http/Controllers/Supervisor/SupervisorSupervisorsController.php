...
class SupervisorSupervisorsController extends BaseSupervisorWebController
{
    public function index(Request $request, $subdomain = null): View
    {
        ...
        $supervisors = User::where('user_type', 'supervisor')
            ...
            ->map(fn ($user) => [
                ...
                'can_confirm_student_emails' => (bool) ($user->supervisorProfile?->can_confirm_student_emails ?? false),
                'can_manage_parents' => (bool) ($user->supervisorProfile?->can_manage_parents ?? false),
                'can_reset_passwords' => (bool) ($user->supervisorProfile?->can_reset_passwords ?? false),
                'can_manage_subscriptions' => (bool) ($user->supervisorProfile?->can_manage_subscriptions ?? false),
                'can_view_subscriptions' => (bool) ($user->supervisorProfile?->can_view_subscriptions ?? false),
    ...
    public function store(Request $request, $subdomain = null): RedirectResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'can_confirm_student_emails' => 'nullable|boolean',
            'can_manage_parents' => 'nullable|boolean',
            'can_reset_passwords' => 'nullable|boolean',
            'can_manage_subscriptions' => 'nullable|boolean',
            'can_view_subscriptions' => 'nullable|boolean',
        ...
        try {
            $profile = SupervisorProfile::create([
                ...
                'can_confirm_student_emails' => $request->boolean('can_confirm_student_emails'),
                ...
                'can_view_subscriptions' => $request->boolean('can_view_subscriptions'),
    ...
    public function update(Request $request, $subdomain, User $supervisor): RedirectResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'first_name' => 'required|string|max:255',
            'last_name' => 'required|string|max:255',
            'email' => ['required', 'email', Rule::unique('users', 'email')->ignore($supervisor->id)->whereNull('deleted_at')],
            'phone' => 'nullable|string|max:20',
            'gender' => 'required|in:male,female',
            'can_manage_teachers' => 'nullable|boolean',
            'can_manage_students' => 'nullable|boolean',
