...
class AuthController extends Controller
{
     ...
     */
    public function showStudentRegistration(Request $request): View
    {
        $subdomain = $request->route('subdomain');
        $academy = Academy::where('subdomain', $subdomain)->first();
     ...
     */
    public function showTeacherRegistration(Request $request): View
    {
        $subdomain = $request->route('subdomain');
        $academy = Academy::where('subdomain', $subdomain)->first();
     ...
     */
    public function registerTeacherStep1(Request $request): RedirectResponse
    {
        $validator = Validator::make($request->all(), [
     ...
     */
    public function showTeacherRegistrationStep2(Request $request): View|RedirectResponse
    {
     ...
     */
    public function registerTeacherStep2(Request $request): RedirectResponse
    {
        $teacherType = $request->session()->get('teacher_type');
        ...
        // Create user and profile in a transaction (rolls back both if either fails)
        try {
            $user = DB::transaction(function () use ($request, $academy, $teacherType) {
                $user = new User([
                    'academy_id' => $academy->id,
                    'first_name' => $request->first_name,
                    'last_name' => $request->last_name,
     ...
     */
    public function showTeacherRegistrationSuccess(Request $request): View
    {
        $subdomain = $request->route('subdomain');
        $academy = Academy::where('subdomain', $subdomain)->first();
