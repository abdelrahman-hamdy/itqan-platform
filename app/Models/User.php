...
class User extends Authenticatable implements FilamentUser, HasTenants, MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        // SECURITY: admin_code excluded — auto-generated by creating observer, never user-supplied
        // SECURITY: active_status excluded — set only via UserService::activate/deactivate
        // SECURITY: email_verified_at excluded — set only via markEmailAsVerified()
        // SECURITY: profile_completed_at excluded — set only via profile completion service
