 ...
 *
 * Tracks student attendance for academic (private lessons) sessions
 * with auto-tracking from LiveKit meetings and manual override capabilities
 */
class AcademicSessionAttendance extends Model
{
    use HasFactory;
    ...
    public function recordJoin(): bool
    {
        ...
        // Get late tolerance from subscription or use default (10 minutes)
        $lateThreshold = $this->session->subscription->late_tolerance_minutes ?? 10;
    ...
    public function calculateAttendanceFromMeetingEvents(): string
    {
        ...
        // Get late tolerance from subscription or use default
        $lateThreshold = $this->session->subscription->late_tolerance_minutes ?? 10;
