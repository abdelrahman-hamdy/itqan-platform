...
class Academy extends Model
{
    ...
    protected $fillable = [
        ...
        'quran_visible', 'quran_template', 'quran_heading', 'quran_subheading', 'quran_show_in_nav', 'quran_show_circles', 'quran_show_teachers',
        'academic_visible', 'academic_template', 'academic_heading', 'academic_subheading', 'academic_show_in_nav', 'academic_show_courses', 'academic_show_teachers',
    ...
    protected $casts = [
        ...
        'quran_show_circles' => 'boolean',
        'quran_show_teachers' => 'boolean',
        'academic_visible' => 'boolean',
        'academic_show_in_nav' => 'boolean',
        'academic_show_courses' => 'boolean',
        'academic_show_teachers' => 'boolean',
