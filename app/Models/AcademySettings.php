...
class AcademySettings extends Model
{
    ...
    protected $fillable = [
        ...
        'teacher_reschedule_deadline_hours',
    ...
    protected $casts = [
        ...
        'teacher_reschedule_deadline_hours' => 'integer',
        'default_attendance_threshold_percentage' => 'decimal:2',
        'student_minimum_presence_percent' => 'decimal:2',
        'student_left_threshold_percent' => 'decimal:2',
        'teacher_full_attendance_percent' => 'decimal:2',
        'teacher_partial_attendance_percent' => 'decimal:2',
    ...
    protected $attributes = [
        ...
        'teacher_reschedule_deadline_hours' => 24,
        'default_attendance_threshold_percentage' => 80.00,
        'student_minimum_presence_percent' => 50.00,
        'student_left_threshold_percent' => 30.00,
