...
CREATE TABLE `academic_grade_levels` (
  ...
  `education_system` enum('primary','middle','secondary','university','vocational','international','special_needs') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'primary',
  `age_group_min` int DEFAULT NULL,
  `age_group_max` int DEFAULT NULL,
  ...
  `assessment_system` enum('percentage','letter_grade','gpa','pass_fail','rubric') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
  `grading_scale` json DEFAULT NULL,
  `pass_percentage` decimal(5,2) NOT NULL DEFAULT '60.00',
  `curriculum_framework` text COLLATE utf8mb4_unicode_ci,
  `learning_outcomes` json DEFAULT NULL,
  `skill_requirements` json DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `display_order` int NOT NULL DEFAULT '1',
  `color_code` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#10B981',
  ...
  KEY `academic_grade_levels_age_group_min_age_group_max_index` (`age_group_min`,`age_group_max`)
...
CREATE TABLE `academic_progress` (
  ...
  `progress_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `engagement_level` enum('excellent','good','average','below_average','poor') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `motivation_level` enum('very_high','high','medium','low','very_low') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `behavioral_notes` text COLLATE utf8mb4_unicode_ci,
  `special_needs_notes` text COLLATE utf8mb4_unicode_ci,
  ...
  `teacher_recommendations` text COLLATE utf8mb4_unicode_ci,
  ...
  `progress_status` enum('excellent','good','satisfactory','needs_improvement','concerning') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'satisfactory',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `academic_settings` (
  ...
  `google_meet_account_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `academic_subjects` (
  ...
  `name_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `category` enum('sciences','mathematics','languages','humanities','social_studies','arts','technology','physical_education','religious_studies','vocational') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sciences',
  `field` enum('natural_sciences','applied_sciences','formal_sciences','humanities','social_sciences','interdisciplinary') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'natural_sciences',
  `level_scope` json DEFAULT NULL,
  `prerequisites` json DEFAULT NULL,
  `color_code` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#3B82F6',
  `icon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `academic_subscriptions` (
  ...
  `subscription_type` enum('private','group') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'private',
  ...
  `timezone` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Asia/Riyadh',
  `auto_create_google_meet` tinyint(1) NOT NULL DEFAULT '1',
  `status` enum('active','paused','suspended','cancelled','expired','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `payment_status` enum('current','pending','overdue','failed','refunded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'current',
  ...
  `trial_session_status` enum('scheduled','completed','missed','cancelled') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `academic_teacher_grade_levels` (
  ...
  `specialization_notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `academic_teacher_profiles` (
  ...
  `education_level` enum('diploma','bachelor','master','phd') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bachelor',
  `university` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `graduation_year` int DEFAULT NULL,
  `qualification_degree` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `bio_arabic` text COLLATE utf8mb4_unicode_ci,
  `bio_english` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `academic_teacher_students` (
  ...
  `start_date` date NOT NULL,
  `end_date` date DEFAULT NULL,
  `status` enum('active','completed','suspended','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
...
CREATE TABLE `academic_teachers` (
  ...
  `approved_by` bigint unsigned DEFAULT NULL,
  `status` enum('pending','active','inactive','suspended','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `rating` decimal(3,2) NOT NULL DEFAULT '0.00',
  `total_students` int NOT NULL DEFAULT '0',
  `total_sessions` int NOT NULL DEFAULT '0',
  `total_courses_created` int NOT NULL DEFAULT '0',
...
CREATE TABLE `academies` (
  ...
  `brand_color` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#0ea5e9',
  `secondary_color` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#10B981',
...
CREATE TABLE `course_enrollments` (
  ...
  `status` enum('enrolled','active','completed','dropped','suspended') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
...
CREATE TABLE `course_quizzes` (
  ...
  `quiz_type` enum('lesson','section','course','assignment') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'lesson',
  ...
  `difficulty_level` enum('very_easy','easy','medium','hard','very_hard') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'medium',
  `instructions` text COLLATE utf8mb4_unicode_ci,
  `completion_message` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `course_subscriptions` (
  ...
  `recorded_course_id` bigint unsigned NOT NULL,
  `subscription_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `enrollment_type` enum('free','paid','trial','gift') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'paid',
  `payment_type` enum('one_time','installment','subscription') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'one_time',
  ...
  `access_type` enum('limited','lifetime') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'limited',
  ...
  `status` enum('active','completed','paused','expired','cancelled','refunded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  ...
  `completion_certificate_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `courses` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `type` enum('individual','group','recorded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'group',
...
CREATE TABLE `interactive_course_enrollments` (
  ...
  `enrollment_status` enum('enrolled','dropped','completed','expelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
...
CREATE TABLE `interactive_course_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `academy_id` bigint unsigned NOT NULL,
  `default_teacher_payment_type` enum('fixed','per_student','per_session') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fixed',
...
CREATE TABLE `interactive_courses` (
  ...
  `course_type` enum('intensive','regular','exam_prep') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'regular',
  ...
  `payment_type` enum('fixed_amount','per_student','per_session') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fixed_amount',
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `enrollment_deadline` date NOT NULL,
  `schedule` json NOT NULL,
  `status` enum('draft','published','active','completed','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `is_published` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `interactive_session_attendances` (
  ...
  `student_id` bigint unsigned NOT NULL,
  `attendance_status` enum('present','absent','late') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'absent',
...
CREATE TABLE `interactive_teacher_payments` (
  ...
  `payment_type` enum('fixed','per_student','per_session') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lessons` (
  ...
  `video_quality` enum('480p','720p','1080p','4K') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '720p',
  ...
  `lesson_type` enum('video','quiz','assignment','reading') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'video',
...
CREATE TABLE `parent_profiles` (
  ...
  `relationship_type` enum('father','mother','guardian','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'father',
  ...
  `preferred_contact_method` enum('phone','email','sms','whatsapp') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'phone',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payments` (
  ...
  `payment_method` enum('credit_card','debit_card','bank_transfer','wallet','cash','mada','visa','mastercard','apple_pay','stc_pay','urpay') COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_gateway` enum('tap','moyasar','payfort','hyperpay','paytabs','manual') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_type` enum('subscription','course','session','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'subscription',
  ...
  `payment_status` enum('pending','processing','paid','failed','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `quran_circle_students` (
  ...
  `status` enum('enrolled','completed','dropped','suspended','transferred') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
  `attendance_count` int NOT NULL DEFAULT '0',
  `missed_sessions` int NOT NULL DEFAULT '0',
  `makeup_sessions_used` int NOT NULL DEFAULT '0',
  `current_level` enum('beginner','elementary','intermediate','advanced','expert') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
...
CREATE TABLE `quran_circles` (
  ...
  `circle_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `description_en` text COLLATE utf8mb4_unicode_ci,
  `circle_type` enum('memorization','recitation','mixed','advanced','beginners') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'memorization',
  `specialization` enum('memorization','recitation','interpretation','arabic_language','complete') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'memorization',
  `memorization_level` enum('beginner','elementary','intermediate','advanced','expert') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  `age_group` enum('children','youth','adults','all_ages') COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender_type` enum('male','female','mixed') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `learning_objectives` json DEFAULT NULL,
  `status` enum('planning','pending','active','ongoing','completed','cancelled','suspended') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'planning',
  `enrollment_status` enum('open','closed','full','waitlist') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'closed',
  `actual_start_date` date DEFAULT NULL,
  `actual_end_date` date DEFAULT NULL,
  `last_session_at` timestamp NULL DEFAULT NULL,
  `next_session_at` timestamp NULL DEFAULT NULL,
  `room_link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `quran_circles_quran_teacher_id_foreign` FOREIGN KEY (`quran_teacher_id`) REFERENCES `quran_teachers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `quran_homework` (
  ...
  `homework_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `homework_type` enum('memorization','recitation','review','research','writing','listening','practice') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'memorization',
  ...
  `pronunciation_notes` text COLLATE utf8mb4_unicode_ci,
  ...
  `submission_method` enum('audio','video','text','file','live','mixed') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submission_text` text COLLATE utf8mb4_unicode_ci,
  `submission_files` json DEFAULT NULL,
  `audio_recording_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_recording_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submission_notes` text COLLATE utf8mb4_unicode_ci,
  `submitted_at` timestamp NULL DEFAULT NULL,
  `submission_status` enum('not_submitted','partial','complete','late','resubmission') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_submitted',
  ...
  `status` enum('assigned','in_progress','submitted','evaluated','completed','overdue','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assigned',
  `completion_percentage` decimal(5,2) NOT NULL DEFAULT '0.00',
  ...
  CONSTRAINT `quran_homework_quran_teacher_id_foreign` FOREIGN KEY (`quran_teacher_id`) REFERENCES `quran_teachers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `quran_progress` (
  ...
  `circle_id` bigint unsigned DEFAULT NULL,
  `session_id` bigint unsigned DEFAULT NULL,
  `progress_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `progress_date` date NOT NULL,
  `progress_type` enum('memorization','recitation','review','assessment','test','milestone') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'memorization',
  `current_surah` int DEFAULT NULL,
  `current_verse` int DEFAULT NULL,
  ...
  `difficulty_level` enum('very_easy','easy','moderate','challenging','very_challenging') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `mastery_level` enum('beginner','developing','proficient','advanced','expert','master') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  ...
  `learning_pace` enum('very_slow','slow','normal','fast','very_fast') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  ...
  `next_steps` json DEFAULT NULL,
  `teacher_notes` text COLLATE utf8mb4_unicode_ci,
  `parent_notes` text COLLATE utf8mb4_unicode_ci,
  `student_feedback` text COLLATE utf8mb4_unicode_ci,
  `assessment_date` date DEFAULT NULL,
  `overall_rating` int DEFAULT NULL COMMENT '1-5 rating',
  `progress_status` enum('on_track','ahead','behind','needs_attention','excellent','struggling') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'on_track',
  `created_by` bigint unsigned DEFAULT NULL,
  `updated_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `quran_progress_quran_teacher_id_foreign` FOREIGN KEY (`quran_teacher_id`) REFERENCES `quran_teachers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `quran_sessions` (
  ...
  `session_type` enum('individual','circle','makeup','trial','assessment') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
  `status` enum('scheduled','ongoing','completed','cancelled','missed','rescheduled','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scheduled',
  ...
  `location_type` enum('online','physical','hybrid') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'online',
  ...
  `recording_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `attendance_status` enum('attended','absent','late','left_early','partial') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `homework_details` text COLLATE utf8mb4_unicode_ci,
  ...
  `parent_feedback` text COLLATE utf8mb4_unicode_ci,
  `overall_rating` int DEFAULT NULL COMMENT '1-5 rating',
  `technical_issues` text COLLATE utf8mb4_unicode_ci,
  ...
  CONSTRAINT `quran_sessions_quran_teacher_id_foreign` FOREIGN KEY (`quran_teacher_id`) REFERENCES `quran_teachers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `quran_subscriptions` (
  ...
  `subscription_type` enum('individual','group') COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_sessions` int NOT NULL,
  ...
  `payment_status` enum('paid','pending','failed','refunded','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `subscription_status` enum('active','expired','paused','cancelled','pending','suspended') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `current_verse` int DEFAULT NULL,
  `verses_memorized` int NOT NULL DEFAULT '0',
  `memorization_level` enum('beginner','elementary','intermediate','advanced','expert','hafiz') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  `progress_percentage` decimal(5,2) NOT NULL DEFAULT '0.00',
  `last_session_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `quran_subscriptions_quran_teacher_id_foreign` FOREIGN KEY (`quran_teacher_id`) REFERENCES `quran_teachers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `quran_teacher_profiles` (
  ...
  `avatar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `teacher_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `educational_qualification` enum('bachelor','master','phd','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bachelor',
  `certifications` json DEFAULT NULL,
  `teaching_experience_years` int NOT NULL DEFAULT '0',
  `available_time_start` time NOT NULL DEFAULT '08:00:00',
  `available_time_end` time NOT NULL DEFAULT '18:00:00',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `quran_teachers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `quran_teachers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `academy_id` bigint unsigned NOT NULL,
  `first_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `last_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `specialization` enum('memorization','recitation','interpretation','arabic_language','general') COLLATE utf8mb4_unicode_ci NOT NULL,
  `has_ijazah` tinyint(1) NOT NULL DEFAULT '0',
  `ijazah_type` enum('memorization','recitation','ten_readings','teaching','general') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ijazah_chain` text COLLATE utf8mb4_unicode_ci,
  `memorization_level` enum('beginner','elementary','intermediate','advanced','expert') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  `teaching_experience_years` int NOT NULL DEFAULT '0',
  `educational_qualification` enum('bachelor','master','phd','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `hourly_rate_individual` decimal(8,2) NOT NULL DEFAULT '0.00',
  `hourly_rate_group` decimal(8,2) NOT NULL DEFAULT '0.00',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SAR',
  `available_days` json DEFAULT NULL,
  ...
  `status` enum('active','inactive','suspended','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `approval_status` enum('pending','approved','rejected','under_review') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `approved_at` timestamp NULL DEFAULT NULL,
  `approved_by` bigint unsigned DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `quran_teachers_academy_id_teacher_code_unique` (`academy_id`,`teacher_code`),
  UNIQUE KEY `quran_teachers_teacher_code_unique` (`teacher_code`),
  UNIQUE KEY `quran_teachers_email_unique` (`email`),
  KEY `quran_teachers_approved_by_foreign` (`approved_by`),
  KEY `quran_teachers_created_by_foreign` (`created_by`),
  KEY `quran_teachers_updated_by_foreign` (`updated_by`),
  KEY `quran_teachers_academy_id_status_index` (`academy_id`,`status`),
  KEY `quran_teachers_academy_id_approval_status_index` (`academy_id`,`approval_status`),
  KEY `quran_teachers_specialization_status_index` (`specialization`,`status`),
  KEY `quran_teachers_has_ijazah_status_index` (`has_ijazah`,`status`),
  KEY `quran_teachers_rating_index` (`rating`),
  KEY `quran_teachers_teaching_experience_years_index` (`teaching_experience_years`),
  CONSTRAINT `quran_teachers_academy_id_foreign` FOREIGN KEY (`academy_id`) REFERENCES `academies` (`id`) ON DELETE CASCADE,
  CONSTRAINT `quran_teachers_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `quran_teachers_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `quran_teachers_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recorded_courses` (
  ...
  `trailer_video_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level` enum('beginner','intermediate','advanced') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  `duration_hours` int NOT NULL DEFAULT '0',
  `language` enum('ar','en','both') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ar',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `session_requests` (
  ...
  `status` enum('pending','teacher_proposed','student_negotiating','teacher_revising','agreed','paid','rejected','cancelled','expired') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `proposed_schedule` json DEFAULT NULL,
  `current_proposal` json DEFAULT NULL,
  `initial_message` text COLLATE utf8mb4_unicode_ci,
  `teacher_response` text COLLATE utf8mb4_unicode_ci,
  `latest_message` text COLLATE utf8mb4_unicode_ci,
  `last_activity_at` timestamp NULL DEFAULT NULL,
  `trial_session_completed` tinyint(1) NOT NULL DEFAULT '0',
  `trial_session_date` timestamp NULL DEFAULT NULL,
  `trial_session_feedback` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `student_profiles` (
  ...
  `academic_status` enum('enrolled','graduated','dropped','transferred') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `student_progress` (
  ...
  `course_section_id` bigint unsigned DEFAULT NULL,
  `lesson_id` bigint unsigned DEFAULT NULL,
  `progress_type` enum('course','section','lesson') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'lesson',
  `progress_percentage` decimal(5,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `subscriptions` (
  ...
  `academy_id` bigint unsigned NOT NULL,
  `student_id` bigint unsigned NOT NULL,
  `subscription_type` enum('quran','academic','recorded_course','general') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `subscription_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plan_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plan_description` text COLLATE utf8mb4_unicode_ci,
  `subscription_category` enum('individual','group','course','package') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SAR',
  `billing_cycle` enum('daily','weekly','monthly','quarterly','yearly','lifetime') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly',
  `status` enum('trial','active','expired','cancelled','suspended','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `payment_status` enum('pending','paid','failed','overdue') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `supervisor_profiles` (
  ...
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `supervisor_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `department` enum('quran','academic','recorded_courses','general') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `supervision_level` enum('junior','senior','lead') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'junior',
  `assigned_teachers` json DEFAULT NULL,
  `monitoring_permissions` json DEFAULT NULL,
  `reports_access_level` enum('basic','detailed','full') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'basic',
...
CREATE TABLE `teacher_subjects` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `subject_id` bigint unsigned NOT NULL,
  `proficiency_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'intermediate',
...
CREATE TABLE `teaching_sessions` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `type` enum('individual','group','assessment') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'group',
  ...
  `google_meet_url` text COLLATE utf8mb4_unicode_ci,
  `notes` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `users` (
  ...
  `role` enum('super_admin','academy_admin','teacher','supervisor','student','parent') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'student',
  `user_type` enum('student','quran_teacher','academic_teacher','parent','supervisor','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'student',
  `status` enum('pending','active','inactive','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `bio` text COLLATE utf8mb4_unicode_ci,
  `teacher_type` enum('quran','academic') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qualification_degree` enum('bachelor','master','phd','other') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qualification_text` text COLLATE utf8mb4_unicode_ci,
  `university` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `users_academy_id_role_index` (`academy_id`,`role`),
