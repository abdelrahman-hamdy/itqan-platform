...
CREATE TABLE `supervisor_profiles` (
  ...
  `department` enum('quran','academic','recorded_courses','general') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `supervision_level` enum('junior','senior','lead') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'junior',
  `assigned_teachers` json DEFAULT NULL,
  `monitoring_permissions` json DEFAULT NULL,
  `reports_access_level` enum('basic','detailed','full') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'basic',
