...
--
-- Host: localhost    Database: itqan_platform
-- ------------------------------------------------------
...
--
-- Table structure for table `academic_grade_levels`
--
...
--
-- Table structure for table `academic_homework`
--
...
--
-- Table structure for table `academic_homework_submissions`
--
...
--
-- Table structure for table `academic_individual_lessons`
--
...
--
-- Table structure for table `academic_packages`
--
...
--
-- Table structure for table `academic_session_attendances`
--
...
--
-- Table structure for table `academic_session_reports`
--
...
--
-- Table structure for table `academic_subject_grade_levels`
--
...
CREATE TABLE `academic_subject_grade_levels` (
  ...
  `semester` enum('first','second','both','summer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'both',
  `is_mandatory` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `academic_subscriptions` (
  ...
  `package_name_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `package_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `academic_teacher_grade_levels`
--
...
--
-- Table structure for table `academic_teacher_profiles`
--
...
CREATE TABLE `academic_teacher_profiles` (
  ...
  `phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+966' COMMENT 'Country calling code',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `teacher_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `education_level` enum('diploma','bachelor','master','phd','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bachelor',
...
--
-- Table structure for table `academic_teacher_students`
--
...
--
-- Table structure for table `academic_teacher_subjects`
--
...
CREATE TABLE `academies` (
  ...
  `gradient_palette` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ocean_breeze',
  ...
  `hero_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `hero_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hero_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `stats_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `stats_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'إنجازاتنا بالأرقام',
  `stats_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `stats_show_in_nav` tinyint(1) NOT NULL DEFAULT '1',
  `reviews_visible` tinyint(1) NOT NULL DEFAULT '1',
  `reviews_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `reviews_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'آراء طلابنا',
  `reviews_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reviews_show_in_nav` tinyint(1) NOT NULL DEFAULT '1',
  `quran_visible` tinyint(1) NOT NULL DEFAULT '1',
  `quran_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `quran_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'برامج القرآن الكريم',
  `quran_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `quran_show_in_nav` tinyint(1) NOT NULL DEFAULT '1',
  `academic_visible` tinyint(1) NOT NULL DEFAULT '1',
  `academic_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `academic_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'البرامج الأكاديمية',
  `academic_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `academic_show_in_nav` tinyint(1) NOT NULL DEFAULT '1',
  `courses_visible` tinyint(1) NOT NULL DEFAULT '1',
  `courses_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `courses_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'الدورات المسجلة',
  `courses_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `courses_show_in_nav` tinyint(1) NOT NULL DEFAULT '1',
  `features_visible` tinyint(1) NOT NULL DEFAULT '1',
  `features_template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'template_1',
  `features_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'مميزات المنصة',
  `features_subheading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Table structure for table `business_service_requests`
--
...
CREATE TABLE `certificates` (
  ...
  `template_style` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ch_messages` (
  ...
  `message_type` enum('text','file','voice','image') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
...
CREATE TABLE `chat_group_members` (
  ...
  KEY `chat_group_members_group_id_role_index` (`group_id`,`role`),
  KEY `chat_group_members_user_id_index` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chat_groups` (
  ...
  KEY `chat_groups_academy_id_is_active_index` (`academy_id`,`is_active`),
  KEY `chat_groups_type_index` (`type`),
...
CREATE TABLE `course_reviews` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `reviewable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'AppModelsRecordedCourse',
  `academy_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `course_subscriptions` (
  ...
  `interactive_course_id` bigint unsigned DEFAULT NULL,
  `subscription_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `course_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recorded',
  ...
  `currency` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SAR',
  `billing_cycle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'lifetime',
...
CREATE TABLE `homework_submissions` (
  ...
  `homework_type` enum('academic','interactive','quran') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `max_score` decimal(5,2) NOT NULL DEFAULT '100.00',
  `score_percentage` decimal(5,2) DEFAULT NULL,
  `grade_letter` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `teacher_feedback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `graded_by` bigint unsigned DEFAULT NULL,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `submission_status` enum('not_started','draft','submitted','late','graded','returned','resubmitted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
  `progress_percentage` decimal(5,2) NOT NULL DEFAULT '0.00',
  `last_auto_save_at` timestamp NULL DEFAULT NULL,
  `auto_save_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `revision_count` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `interactive_course_enrollments`
--
...
--
-- Table structure for table `interactive_course_homework`
--
...
--
-- Table structure for table `interactive_course_sessions`
--
...
CREATE TABLE `interactive_course_sessions` (
  ...
  `meeting_platform` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'livekit',
  `meeting_data` json DEFAULT NULL,
  `meeting_room_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `lesson_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'محتوى الدرس',
  ...
  `actual_duration_minutes` int DEFAULT NULL,
  `status` enum('unscheduled','scheduled','ready','ongoing','completed','cancelled','absent','missed','rescheduled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scheduled',
  `attendance_count` int NOT NULL DEFAULT '0',
  ...
  `homework_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `interactive_courses`
--
...
CREATE TABLE `interactive_courses` (
  ...
  `certificate_template_style` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'template_1',
...
--
-- Table structure for table `interactive_session_attendances`
--
...
--
-- Table structure for table `interactive_session_reports`
--
...
--
-- Table structure for table `meeting_attendance_events`
--
...
CREATE TABLE `meeting_attendances` (
  ...
  `session_type` enum('individual','group','academic','interactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'individual',
...
CREATE TABLE `parent_profiles` (
  ...
  `phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+966' COMMENT 'Country calling code for primary phone',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `relationship_type` enum('father','mother','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `secondary_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Country calling code for secondary phone',
...
CREATE TABLE `parent_student_relationships` (
  ...
  `student_id` bigint unsigned NOT NULL,
  `relationship_type` enum('father','mother','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'other',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payment_webhook_events` (
  ...
  `event_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique event ID for idempotency',
  `transaction_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `payments` (
  ...
  `payment_method_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'e.g., card, wallet, bank_transfer',
  ...
  `gateway_intent_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Gateway payment intent/session ID',
  `gateway_order_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Gateway order ID',
  `client_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Client secret for frontend',
  `redirect_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iframe_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `quiz_assignments` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quiz_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `assignable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `assignable_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quiz_attempts` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quiz_assignment_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `student_id` bigint unsigned NOT NULL,
...
--
-- Table structure for table `quran_circle_schedules`
--
...
--
-- Table structure for table `quran_circle_students`
--
...
--
-- Table structure for table `quran_circles`
--
...
--
-- Table structure for table `quran_individual_circles`
--
...
--
-- Table structure for table `quran_packages`
--
...
--
-- Table structure for table `quran_session_attendances`
--
...
--
-- Table structure for table `quran_session_homework`
--
...
--
-- Table structure for table `quran_session_homeworks`
--
...
--
-- Table structure for table `quran_sessions`
--
...
CREATE TABLE `quran_sessions` (
  ...
  `session_type` enum('individual','group','trial') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
...
--
-- Table structure for table `quran_subscriptions`
--
...
--
-- Table structure for table `quran_teacher_profiles`
--
...
--
-- Table structure for table `quran_trial_requests`
--
...
CREATE TABLE `student_profiles` (
  ...
  `last_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+966' COMMENT 'Country calling code for student phone',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `emergency_contact_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Country calling code for emergency contact',
  `parent_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Parent phone number in E.164 format',
  `parent_phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+966' COMMENT 'Country calling code (e.g., +966 for Saudi Arabia)',
  `parent_phone_country` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SA' COMMENT 'ISO 3166-1 alpha-2 country code',
...
--
-- Table structure for table `student_session_reports`
--
...
CREATE TABLE `teacher_earnings` (
  ...
  `academy_id` bigint unsigned NOT NULL,
  `teacher_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `teacher_id` bigint unsigned NOT NULL,
  ...
  `dispute_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `teacher_payouts` (
  ...
  `teacher_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `teacher_id` bigint unsigned NOT NULL,
  `payout_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payout_month` date NOT NULL,
  `total_amount` decimal(10,2) NOT NULL,
  `sessions_count` int NOT NULL,
  `breakdown` json DEFAULT NULL,
  `status` enum('pending','approved','paid','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `approved_by` bigint unsigned DEFAULT NULL,
...
--
-- Table structure for table `teacher_video_settings`
--
...
--
-- Table structure for table `teaching_session_attendances`
--
...
CREATE TABLE `users` (
  ...
  `phone_country_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+966' COMMENT 'Country calling code (e.g., +966 for Saudi Arabia)',
...
--
-- Table structure for table `wire_actions`
--
...
--
-- Table structure for table `wire_attachments`
--
...
--
-- Table structure for table `wire_conversations`
--
...
--
-- Table structure for table `wire_groups`
--
...
--
-- Table structure for table `wire_messages`
--
...
--
-- Table structure for table `wire_participants`
--
...
-- Dump completed on 2025-12-22 18:49:11
