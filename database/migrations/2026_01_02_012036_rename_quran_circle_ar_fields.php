...
/**
 * Rename Arabic fields to simple names in quran_circles table.
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('quran_circles', function (Blueprint $table) {
            if (Schema::hasColumn('quran_circles', 'name_ar')) {
                $table->renameColumn('name_ar', 'name');
            }
            if (Schema::hasColumn('quran_circles', 'description_ar')) {
    ...
    {
        Schema::table('quran_circles', function (Blueprint $table) {
            if (Schema::hasColumn('quran_circles', 'name')) {
                $table->renameColumn('name', 'name_ar');
            }
            if (Schema::hasColumn('quran_circles', 'description')) {
