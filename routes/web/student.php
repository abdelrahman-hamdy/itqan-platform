...
Route::domain('{subdomain}.'.config('app.domain'))->group(function () {
    ...
    Route::middleware(['auth', 'role:student'])->group(function () {
        ...
        */
        ...
        Route::get('/subscriptions/{type}/{id}/manual-renewal', [\App\Http\Controllers\SubscriptionManualRenewalController::class, 'show'])->where('type', 'quran|academic')->name('student.subscriptions.manual-renewal');
        Route::post('/subscriptions/{type}/{id}/manual-renewal', [\App\Http\Controllers\SubscriptionManualRenewalController::class, 'process'])->where('type', 'quran|academic')->name('student.subscriptions.manual-renewal.process');
