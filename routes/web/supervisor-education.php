...
Route::domain('{subdomain}.'.config('app.domain'))->group(function () {
    Route::middleware(['auth', 'role:supervisor,super_admin,admin'])->prefix('manage')->name('manage.')->group(function () {
        ...
        Route::post('/subscriptions/{type}/{subscription}/create-circle', [SupervisorSubscriptionsController::class, 'createCircle'])->name('subscriptions.create-circle')->whereIn('type', ['quran', 'academic']);
