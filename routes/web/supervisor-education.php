...
use App\Http\Controllers\Supervisor\SupervisorOverflowReviewController;
...
Route::domain('{subdomain}.'.config('app.domain'))->group(function () {
    Route::middleware(['auth', 'role:supervisor,super_admin,admin'])->prefix('manage')->name('manage.')->group(function () {
        ...
        Route::post('/group-circles/{circle}/toggle-enrollment', [SupervisorGroupCirclesController::class, 'toggleEnrollment'])->name('group-circles.toggle-enrollment');
