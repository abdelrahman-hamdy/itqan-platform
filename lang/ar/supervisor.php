...
return [
    ...
    'group_circles' => [
        ...
        'circle_status' => 'الحلقة مفعّلة',
        'circle_status_help' => 'إلغاء التفعيل يوقف الحلقة ويمنع الطلاب من الانضمام',
        ...
        // Create / Edit form
        'create_circle' => 'إضافة حلقة جديدة',
        'edit_circle' => 'تعديل الحلقة',
        'circle_created' => 'تم إنشاء الحلقة بنجاح',
        'breadcrumb_create' => 'إضافة حلقة جديدة',
        'breadcrumb_edit' => 'تعديل الحلقة',
        'page_subtitle_create' => 'أدخل تفاصيل الحلقة الجماعية لإنشائها',
        'page_subtitle_edit' => 'حدّث تفاصيل الحلقة الجماعية',
        'classification_section' => 'التصنيف',
        'teacher_capacity_section' => 'المعلم والسعة',
        'pricing_section' => 'الرسوم',
        'objectives_section' => 'الأهداف التعليمية',
        'admin_section' => 'الإعدادات الإدارية',
        'progress_section' => 'تتبع التقدم',
        'progress_section_help' => 'يتم حسابها تلقائياً من واجبات الجلسات',
        'circle_code' => 'رمز الحلقة',
        'circle_code_help' => 'يتم توليده تلقائياً عند الإنشاء',
        'name_placeholder' => 'مثال: حلقة الفرقان للحفظ',
        'description_help' => 'وصف مختصر يظهر للطلاب وأولياء الأمور',
        'select_placeholder' => '— اختر —',
        'teacher_search_placeholder' => 'ابحث عن معلم...',
        'no_matching_teachers' => 'لا يوجد معلمون مطابقون',
        'learning_objectives' => 'أهداف الحلقة',
        'learning_objectives_help' => 'أضف هدفاً تعليمياً واضحاً ثم اضغط Enter',
        'learning_objectives_placeholder' => 'أضف هدفاً واضغط Enter',
        'enrollment_status' => 'حالة التسجيل',
        'enrollment_status_help' => 'تفعيل أو إغلاق التسجيل في الحلقة',
        'recording_enabled' => 'تسجيل الجلسات مفعّل',
        'recording_enabled_help' => 'سيتم تسجيل الجلسات لمراجعتها لاحقاً',
        'total_memorized_pages' => 'الصفحات المحفوظة',
        'total_reviewed_pages' => 'الصفحات المراجَعة',
        'total_reviewed_surahs' => 'السور المراجَعة',
        'submit_create' => 'إنشاء الحلقة',
    ...
    'teacher_earnings' => [
        ...
        'export_type_details' => 'تفاصيل الأرباح',
        'export_columns_label' => 'الأعمدة المراد تصديرها',
        'export_columns_select_all' => 'تحديد الكل',
        'export_columns_clear_all' => 'إلغاء الكل',
        'export_columns_required' => 'يجب اختيار عمود واحد على الأقل',
        'export_details_report_title' => 'تقرير تفاصيل أرباح المعلمين',
        // Details export columns
        'details_col_teacher' => 'اسم المعلم',
        'details_col_source_type' => 'نوع المصدر',
        'details_col_source_name' => 'اسم الحلقة/الدرس/الدورة',
        'details_col_session_date' => 'تاريخ الجلسة',
        'details_col_earning_month' => 'شهر الأرباح',
        'details_col_duration' => 'المدة (دقيقة)',
        'details_col_calculation_method' => 'طريقة الحساب',
        'details_col_amount' => 'المبلغ',
        'details_col_status' => 'الحالة',
        'details_col_dispute_notes' => 'ملاحظات النزاع',
    ...
    'subscriptions' => [
        ...
        'resumed_success' => 'تم استئناف الاشتراك',
        'pause_reason_manual_default' => 'إيقاف يدوي بواسطة المشرف',
        ...
        'previous_package_retired_admin' => 'الباقة السابقة غير متاحة. اختر باقة نشطة للتجديد.',
        'new_price_preview' => 'السعر الجديد',
        'min_suffix' => 'د',
        // Cycle inspector + data-fix tool (F2)
        'inspect' => 'فحص',
        'inspect_cycle' => 'فحص الدورة',
        'cycle_inspect_title' => 'فحص الدورة #:number',
        'back_to_subscription' => 'العودة للاشتراك',
        'cycle_invariant_violations' => ':count مخالفة لقواعد الدورة',
        'no_violations_for_cycle' => 'جميع القواعد سليمة في هذه الدورة.',
        'show_context' => 'عرض التفاصيل',
        'cycle_row' => 'بيانات الدورة',
        'cycle_id_label' => 'معرّف الدورة',
        'starts_at' => 'تبدأ في',
        'ends_at' => 'تنتهي في',
        'total_sessions' => 'إجمالي الحصص',
        'sessions_used' => 'الحصص المستهلكة',
        'read_only' => '(غير قابل للتعديل)',
        'derived_label' => 'المحسوب',
        'sessions_used_inv_b3_hint' => 'INV-B3: هذا العمود ينعكس من سجلات استهلاك الحصص. استخدم محرر الاستهلاك أدناه لتعديله.',
        'carryover_sessions' => 'الحصص المنقولة',
        'package_id_label' => 'الباقة',
        'pricing_source_label' => 'مصدر التسعير',
        'final_price' => 'السعر النهائي',
        'grace_period_ends_at' => 'انتهاء فترة السماح',
        'archived_at' => 'تاريخ الأرشفة',
        'queued_sibling_anchor' => 'ربط الدورة الموقوفة (INV-A5)',
        'active_cycle' => 'الدورة النشطة',
        'queued_cycle' => 'الدورة الموقوفة',
        'inv_a5_mismatch' => 'مخالفة INV-A5: بداية الموقوفة يجب أن تساوي نهاية النشطة.',
        'sessions_anchored' => 'الحصص المرتبطة (:count)',
        ...
        'delete' => 'حذف',
        'cancel' => 'إلغاء',
        'confirm_delete_session' => 'حذف نهائي لهذه الحصة المجدولة؟ لا توجد بها بيانات حضور أو تقارير.',
        'confirm_cancel_session' => 'وضع الحصة كملغاة؟',
        'consumption_rows' => 'سجلات الاستهلاك (:count)',
        'consumption_rows_hint' => 'المصدر الفعلي لعدد الحصص المستهلكة (INV-B3)',
        'no_consumption_rows' => 'لا توجد سجلات استهلاك لهذه الدورة.',
        'session' => 'الحصة',
        'consumed_at' => 'تاريخ الاستهلاك',
        'consumption_type' => 'النوع',
        'consumption_source' => 'المصدر',
        'consumption_status' => 'الحالة',
        'actions' => 'إجراءات',
        'reversed_at_label' => 'تم العكس',
        'active' => 'نشط',
        'reverse' => 'عكس',
        'promote' => 'ترقية',
        're_record' => 'إعادة تسجيل',
        'confirm_reverse_consumption' => 'عكس هذا السجل؟ سيقل عدد الحصص المستهلكة بواحد.',
        'payments_for_cycle' => 'المدفوعات (:count)',
        'no_payments' => 'لا توجد مدفوعات مرتبطة بهذه الدورة.',
        'consumption_reversed_success' => 'تم عكس السجل وإعادة احتساب الحصص المستهلكة.',
        'consumption_promoted_success' => 'تم تحديث السجل إلى مصدر إداري (admin_manual).',
        'consumption_recorded_success' => 'تم تسجيل سجل الاستهلاك.',
        'consumption_missing_session_or_student' => 'تعذّر التحديث: لا يوجد طالب أو حصة مرتبطة بهذا السجل.',
        'session_missing_student' => 'تعذّر تسجيل الاستهلاك: لا يوجد طالب مرتبط بالاشتراك.',
        'session_deleted_success' => 'تم حذف الحصة.',
        'session_cancelled_success' => 'تم إلغاء الحصة.',
        'session_delete_blocked_status' => 'يمكن حذف الحصص المجدولة فقط.',
        'session_delete_blocked_attendance' => 'تعذّر الحذف: توجد بيانات حضور للحصة.',
        'session_delete_blocked_reports' => 'تعذّر الحذف: توجد تقارير للحصة.',
        'session_delete_blocked_consumption' => 'تعذّر الحذف: توجد سجلات استهلاك للحصة. اعكسها أولاً.',
        'session_delete_blocked_earnings' => 'تعذّر الحذف: توجد عوائد للمعلم على الحصة.',
        'edit_cycle' => 'تعديل الدورة',
        'edit_cycle_modal_title' => 'تعديل الدورة #:number',
        'cycle_edit_conflicts' => 'تعذّر الحفظ — التعديلات تتعارض مع البيانات الحالية. أصلح المشاكل أدناه أولاً.',
        'cycle_edit_fix_first' => 'عالج كل تعارض أعلاه (احذف حصة مستقبلية، اعكس سجل استهلاك، إلخ) ثم أعد الإرسال.',
        'cycle_edit_success' => 'تم تحديث الدورة.',
        'forbidden_fields' => 'حقول غير قابلة للتعديل',
        'forbidden_fields_hint' => 'استخدم إجراءات الصفوف هنا (عكس / ترقية / تسجيل استهلاك) أو تدفقات الإيقاف/الاستئناف/الإلغاء الموجودة لتغيير هذه الحقول.',
        'save_changes' => 'حفظ التعديلات',
        ...
        'tab_extension_period' => 'فترة التمديد',
        ...
        'no_sessions_extension_period' => 'لا توجد جلسات في فترة التمديد.',
        'extension_active_until' => 'هذا الاشتراك مُمدَّد حتى :date',
        'extension_paid_window_ended' => 'الفترة المدفوعة انتهت في :date',
