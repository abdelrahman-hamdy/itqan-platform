...
return [
    ...
    'subscription' => [
        ...
        'payment_declined' => 'تم رفض عملية الدفع من البنك. يرجى المحاولة مرة أخرى أو استخدام بطاقة أخرى',
        'payment_failed_generic' => 'فشلت عملية الدفع. يرجى المحاولة مرة أخرى',
    ...
    'country_filter' => [
        'section_title' => 'إتاحة البوابة حسب الدولة',
        'section_description' => 'تحكم في الدول المسموح لها باستخدام هذه البوابة. اترك الحقلين فارغين لاستخدام الدول المدعومة افتراضياً من البوابة.',
        'allowed_label' => 'الدول المسموح بها',
        'allowed_helper' => 'إذا تم تحديد دول هنا، لن تظهر هذه البوابة إلا للمستخدمين من هذه الدول (مع احترام الدول المدعومة افتراضياً من البوابة).',
        'blocked_label' => 'الدول الممنوعة',
        'blocked_helper' => 'إذا تم تحديد دول هنا، ستظهر البوابة لجميع المستخدمين باستثناء المنتمين إلى هذه الدول. يتم تجاهل هذا الحقل إذا تم ملء قائمة الدول المسموح بها.',
