...
return [
    ...
    */
    ...
    'system' => [
        ...
        'how_to_reset_title' => 'إعادة تعيين الأذونات',
        'modal_subtitle' => 'تم حظر الكاميرا أو الميكروفون مسبقاً. اتبع الخطوات التالية لإعادة التفعيل.',
        'modal_got_it' => 'فهمت',
        'how_to_reset_step1_title' => 'افتح إعدادات الموقع',
        'how_to_reset_step1' => 'اضغط على أيقونة القفل 🔒 أو أيقونة الإعدادات الموجودة في شريط العنوان بالأعلى',
        'how_to_reset_step2_title' => 'غيّر الأذونات',
        'how_to_reset_step2' => 'ابحث عن الكاميرا والميكروفون وغيّر الإعداد من "حظر" إلى "سماح"',
        'how_to_reset_step3_title' => 'أعد تحميل الصفحة',
        'how_to_reset_step3' => 'بعد تغيير الإعدادات، أعد تحميل الصفحة ليتم تطبيق التغييرات',
        'allowed' => 'مسموح',
        'denied' => 'مرفوض',
