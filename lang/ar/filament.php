...
return [
    ...
    'trial_reschedule' => [
        'label' => 'إعادة جدولة',
        'heading' => 'إعادة جدولة الجلسة التجريبية',
        'description' => 'الجلسة السابقة تم تسجيلها كغياب. يمكنك إعادة جدولتها لموعد جديد.',
        'new_date' => 'الموعد الجديد',
        'meeting_hint' => 'سيتم إنشاء غرفة اجتماع جديدة تلقائياً عند اقتراب الموعد',
        'reason' => 'سبب إعادة الجدولة',
        'optional' => 'اختياري',
        'cannot_reschedule' => 'لا يمكن إعادة جدولة هذه الجلسة',
        'not_absent' => 'الجلسة ليست في حالة غياب',
        'failed' => 'فشل في إعادة جدولة الجلسة',
        'failed_body' => 'حدث خطأ أثناء إعادة الجدولة. يرجى المحاولة مرة أخرى.',
        'success' => 'تمت إعادة جدولة الجلسة التجريبية',
        'success_body' => 'تم تحديث موعد الجلسة للطالب :student',
    ],
];
