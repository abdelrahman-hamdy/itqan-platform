...
return [
    ...
    */
    ...
    'subscriptions' => [
        ...
        'description' => 'إدارة جميع اشتراكاتك والدورات المسجلة',
        ...
        'no_results_description' => 'لم يتم العثور على اشتراكات تطابق معايير البحث',
        ...
        'confirm_toggle_renew_enable' => 'هل أنت متأكد من تفعيل التجديد التلقائي لهذا الاشتراك؟',
    ...
    'interactive_course' => [
        ...
        'course_progress' => 'التقدم في الدورة',
        'payment_status' => 'حالة الدفع',
        'enroll_title' => 'التسجيل في الدورة',
        'enroll_button' => 'سجل الآن',
        'confirm_enrollment_title' => 'تأكيد التسجيل في الكورس',
    ...
    'calendar' => [
        ...
        'modal' => [
            'date_label' => 'التاريخ',
            'time_label' => 'الوقت',
            'duration_label' => 'مدة الجلسة',
            'teacher_label' => 'المعلم',
            'description_label' => 'وصف الجلسة',
            'participants_label' => 'المشاركون في الجلسة',
    ...
    'search' => [
        ...
        'section_academic_sessions' => 'دروسي الخاصة',
    ...
    'quran_circles' => [
        ...
        'enrollment_status_label' => 'حالة التسجيل',
        'status_all' => 'الكل',
        'status_my_circles' => 'حلقاتي',
        'status_available' => 'متاحة للتسجيل',
        'status_open' => 'مفتوحة',
        'status_full' => 'مكتملة',
    ...
    'homework' => [
        ...
        'filter_status_submitted' => 'تم التسليم',
        'filter_status_graded' => 'تم التصحيح',
        'filter_status_overdue' => 'متأخر',
        'filter_status_late' => 'تسليم متأخر',
        'filter_type_label' => 'نوع الواجب',
        'filter_type_all' => 'جميع الأنواع',
        'filter_type_academic' => 'أكاديمي',
        'filter_type_quran' => 'قرآن',
    ...
    'quiz' => [
        ...
        'answer_all_warning' => 'تأكد من إجابتك على جميع الأسئلة قبل التقديم',
        'submit_quiz' => 'تقديم الاختبار',
        'confirm_submit_title' => 'تأكيد تقديم الاختبار',
        'confirm_submit_message' => 'هل أنت متأكد من تقديم الاختبار؟',
        ...
        'passed' => 'ناجح',
        'failed' => 'لم ينجح',
        'attempts_count_label' => 'عدد المحاولات',
        'out_of' => 'من أصل',
        'passing_score' => 'درجة النجاح',
        'attempt_history' => 'سجل المحاولات',
        'attempt_label' => 'المحاولة',
        'score_label' => 'الدرجة',
        'status_label' => 'الحالة',
    ...
    'saved_payment_methods' => [
        ...
        'load_form_error' => 'حدث خطأ أثناء تحميل نموذج إضافة البطاقة. يرجى المحاولة مرة أخرى.',
        'tokenization_request_error' => 'فشل في إنشاء طلب حفظ البطاقة',
        'tokenization_session_error' => 'فشل في الحصول على مفتاح الجلسة',
    ...
    'teacher_detail' => [
        ...
        'quran_teacher_certified' => 'معلم مؤهل ومعتمد في',
        'academic_teacher_title' => 'المعلم الأكاديمي',
    ...
    'course_session' => [
        ...
        'interactive_course_default' => 'كورس تفاعلي',
        'interactive_courses_breadcrumb' => 'الكورسات التفاعلية',
        ...
        'join_10_minutes_before' => 'يمكنك الانضمام قبل 10 دقائق من موعد البدء',
        'starts_in' => 'تبدأ :time',
    ...
    'session_detail' => [
        ...
        'academic_description_prefix' => 'تفاصيل الجلسة الأكاديمية مع',
        'academic_teacher_default' => 'المعلم الأكاديمي',
        'academic_teachers_breadcrumb' => 'المعلمون الأكاديميون',
        'academic_lesson_default' => 'درس أكاديمي',
        'session_summary' => 'ملخص الجلسة',
        'lesson_content' => 'محتوى الدرس:',
        'learning_outcomes' => 'نواتج التعلم:',
        'your_rating' => 'تقييمك للجلسة',
        'share_feedback' => 'شاركنا رأيك في الجلسة',
        'feedback_placeholder' => 'كيف كانت الجلسة؟ ما الذي أعجبك؟ ما المقترحات للتحسين؟',
        'submit_rating' => 'إرسال التقييم',
        'rating_required' => 'الرجاء كتابة تقييمك للجلسة',
        'rating_success' => 'تم إرسال تقييمك بنجاح',
        'rating_error' => 'حدث خطأ أثناء إرسال التقييم. الرجاء المحاولة مرة أخرى.',
        'submitting' => 'جارٍ التسليم...',
        'attached_file' => 'الملف المرفق',
        'homework_submitted' => 'تم تسليم الواجب',
        'homework_submit_error' => 'حدث خطأ أثناء تسليم الواجب. الرجاء المحاولة مرة أخرى.',
        'quran_session_default' => 'جلسة قرآن',
        'quran_description_prefix' => 'تفاصيل جلسة القرآن مع',
    ...
    'certificates' => [
        ...
        'parent_description' => 'عرض جميع الشهادات التي حصل عليها أبناؤك',
        'total_count' => 'إجمالي الشهادات',
        'filter_all' => 'الكل',
        'filter_recorded_courses' => 'الدورات المسجلة',
        'filter_recorded_courses_prefix' => 'الدورات',
        'filter_recorded_courses_suffix' => 'المسجلة',
        'filter_interactive_courses' => 'الدورات التفاعلية',
        'filter_interactive_courses_prefix' => 'الدورات',
        'filter_interactive_courses_suffix' => 'التفاعلية',
        'filter_quran' => 'حلقات القرآن',
        'filter_quran_prefix' => 'حلقات',
        'filter_quran_suffix' => 'القرآن',
        'filter_academic' => 'الدروس الأكاديمية',
        'filter_academic_prefix' => 'الدروس',
        'filter_academic_suffix' => 'الأكاديمية',
        'no_certificates_title' => 'لا توجد شهادات بعد',
        'no_certificates_student' => 'ستظهر شهاداتك هنا عند إتمام الدورات أو استلام شهادات من المعلمين',
    ...
    'group_circle' => [
        ...
        'modal_cancel' => 'إلغاء',
        'modal_leave_title' => 'إلغاء التسجيل',
        ...
        'leave_error_title' => 'خطأ',
        'leave_error_message' => 'حدث خطأ أثناء إلغاء التسجيل',
    ...
    'profile' => [
        ...
        'individual_circles_subtitle' => 'دروس فردية مع معلمي القرآن المؤهلين',
        ...
        'active_subscriptions' => 'اشتراك نشط',
        ...
        'no_trial_requests_description' => 'احجز جلسة تجريبية مجانية مع أحد معلمي القرآن المؤهلين وابدأ رحلة التعلم.',
    ...
    'academic_teachers' => [
        ...
        'my_teachers_count' => 'معلميني الحاليين:',
        'available_teachers' => 'معلم متاح',
    ...
    'academic_teacher_detail' => [
        ...
        'subjects_and_grades' => 'المواد والمراحل الدراسية',
        'teaching_subjects' => 'المواد التدريسية',
        'grade_levels' => 'المراحل الدراسية',
        'features_title' => 'مميزات الدروس الخصوصية',
        'features' => [
    ...
    'confirm' => [
        ...
        'toggle_confirm_prefix' => 'هل أنت متأكد من',
