...
return [
    ...
    'gradient_palette' => [
        ...
        'warm_flame' => 'لهب دافئ',
        'royal_blue' => 'أزرق ملكي',
        'golden_hour' => 'ساعة ذهبية',
        'coral_reef' => 'شعاب مرجانية',
        'mint_fresh' => 'نعناع منعش',
        'sky_blue' => 'أزرق سماوي',
        'lavender_mist' => 'ضباب اللافندر',
        'teal_wave' => 'موجة فيروزية',
        'cherry_blossom' => 'أزهار الكرز',
        'midnight_blue' => 'أزرق منتصف الليل',
        'emerald_gold' => 'زمرد وذهب',
        'desert_sand' => 'رمال الصحراء',
        'mosque_gold' => 'ذهب المسجد',
        'arabian_night' => 'ليالي عربية',
    ],
    'country' => [
        'SA' => 'السعودية',
