...
return [
    ...
    'group_circles' => [
        ...
        'schedule_time' => 'Time',
        'circle_status' => 'Circle is active',
        'circle_status_help' => 'Unchecking deactivates the circle and blocks new enrollments',
        ...
        // Create / Edit form
        'create_circle' => 'New Group Circle',
        'edit_circle' => 'Edit Circle',
        'circle_created' => 'Circle created successfully',
        'breadcrumb_create' => 'New Group Circle',
        'breadcrumb_edit' => 'Edit Circle',
        'page_subtitle_create' => 'Enter the details to create a new group circle',
        'page_subtitle_edit' => 'Update the group circle details',
        'classification_section' => 'Classification',
        'teacher_capacity_section' => 'Teacher & Capacity',
        'pricing_section' => 'Pricing',
        'objectives_section' => 'Learning Objectives',
        'admin_section' => 'Administrative Settings',
        'progress_section' => 'Progress Tracking',
        'progress_section_help' => 'Calculated automatically from session homework',
        'circle_code' => 'Circle Code',
        'circle_code_help' => 'Generated automatically on creation',
        'name_placeholder' => 'e.g. Al-Furqan Memorization Circle',
        'description_help' => 'Short description shown to students and parents',
        'select_placeholder' => '— Select —',
        'teacher_search_placeholder' => 'Search a teacher...',
        'no_matching_teachers' => 'No matching teachers',
        'learning_objectives' => 'Learning Objectives',
        'learning_objectives_help' => 'Type an objective and press Enter to add it',
        'learning_objectives_placeholder' => 'Add an objective and press Enter',
        'enrollment_status' => 'Enrollment Status',
        'enrollment_status_help' => 'Open or close enrollment for this circle',
        'recording_enabled' => 'Session recording enabled',
        'recording_enabled_help' => 'Sessions will be recorded for later review',
        'total_memorized_pages' => 'Memorized Pages',
        'total_reviewed_pages' => 'Reviewed Pages',
        'total_reviewed_surahs' => 'Reviewed Surahs',
        'submit_create' => 'Create Circle',
    ...
    'sessions' => [
        ...
        'filter_date_custom' => 'Custom Date',
        'filter_date_from' => 'From',
        'filter_date_to' => 'To',
        'filter_status' => 'Status',
        'filter_need_review' => 'Need Review',
        'filter_teacher' => 'Teacher',
        'filter_student' => 'Student',
        'filter_gender_all' => 'All',
        'filter_gender_male' => 'Male Teacher',
        'filter_gender_female' => 'Female Teacher',
    ...
    'teacher_earnings' => [
        ...
        'export_type_details' => 'Earnings Details',
        'export_columns_label' => 'Columns to Export',
        'export_columns_select_all' => 'Select All',
        'export_columns_clear_all' => 'Clear All',
        'export_columns_required' => 'Please select at least one column',
        'export_details_report_title' => 'Teacher Earnings Details Report',
        // Details export columns
        'details_col_teacher' => 'Teacher',
        'details_col_source_type' => 'Source Type',
        'details_col_source_name' => 'Circle/Lesson/Course',
        'details_col_session_date' => 'Session Date',
        'details_col_earning_month' => 'Earning Month',
        'details_col_duration' => 'Duration (min)',
        'details_col_calculation_method' => 'Calculation Method',
        'details_col_amount' => 'Amount',
        'details_col_status' => 'Status',
        'details_col_dispute_notes' => 'Dispute Notes',
    ...
    'supervisors' => [
        ...
        'can_view_subscriptions_description' => 'View subscriptions only without actions',
        'can_manage_subscriptions' => 'Manage Subscriptions',
        'can_manage_subscriptions_description' => 'View, create, activate, pause, extend, and manage subscriptions',
        ...
        'can_manage_recording' => 'Monitor & Record Sessions',
        'can_manage_recording_description' => 'Monitor live sessions and manage their recordings',
    ...
    'subscriptions' => [
        ...
        'previous_package_retired_admin' => 'The previous package is retired. Pick an active package to renew.',
        'new_price_preview' => 'New price',
        'min_suffix' => 'min',
        // Cycle inspector + data-fix tool (F2)
        'inspect' => 'Inspect',
        'inspect_cycle' => 'Inspect cycle',
        'cycle_inspect_title' => 'Inspect cycle #:number',
        'back_to_subscription' => 'Back to subscription',
        'cycle_invariant_violations' => ':count invariant violation(s) on this cycle',
        'no_violations_for_cycle' => 'All invariants hold for this cycle.',
        ...
        'sessions_used_inv_b3_hint' => 'INV-B3: this column is a cache of active session_consumption rows. Use the consumption editor below to change it.',
        'carryover_sessions' => 'Carryover sessions',
        'package_id_label' => 'Package',
        'pricing_source_label' => 'Pricing source',
        'final_price' => 'Final price',
        'grace_period_ends_at' => 'Grace period ends',
        'archived_at' => 'Archived at',
        'queued_sibling_anchor' => 'Queued sibling anchor (INV-A5)',
        'active_cycle' => 'Active cycle',
        'queued_cycle' => 'Queued cycle',
        'inv_a5_mismatch' => 'INV-A5 mismatch: queued.starts_at must equal active.ends_at.',
        'sessions_anchored' => 'Sessions anchored (:count)',
        ...
        'delete' => 'Delete',
        'cancel' => 'Cancel',
        'confirm_delete_session' => 'Hard-delete this scheduled session? It has no attendance or reports.',
        'confirm_cancel_session' => 'Mark this session as CANCELLED?',
        'consumption_rows' => 'Consumption rows (:count)',
        'consumption_rows_hint' => 'Truth-source for sessions_used (INV-B3)',
        'no_consumption_rows' => 'No consumption rows recorded for this cycle.',
        'session' => 'Session',
        'consumed_at' => 'Consumed at',
        'consumption_type' => 'Type',
        'consumption_source' => 'Source',
        'consumption_status' => 'State',
        'actions' => 'Actions',
        'reversed_at_label' => 'reversed',
        'active' => 'active',
        'reverse' => 'Reverse',
        'promote' => 'Promote',
        're_record' => 'Re-record',
        'confirm_reverse_consumption' => 'Reverse this consumption row? sessions_used will drop by 1.',
        'payments_for_cycle' => 'Payments (:count)',
        'no_payments' => 'No payments tied to this cycle.',
        'consumption_reversed_success' => 'Consumption row reversed. sessions_used recomputed.',
        'consumption_promoted_success' => 'Consumption row updated to admin_manual.',
        'consumption_recorded_success' => 'Consumption row recorded.',
        'consumption_missing_session_or_student' => 'Cannot promote: the consumption row has no resolvable session or student.',
        'session_missing_student' => 'Cannot record consumption: the subscription has no student attached.',
        'session_deleted_success' => 'Session deleted.',
        'session_cancelled_success' => 'Session cancelled.',
        'session_delete_blocked_status' => 'Only scheduled sessions can be deleted.',
        'session_delete_blocked_attendance' => 'Cannot delete: session has attendance rows.',
        'session_delete_blocked_reports' => 'Cannot delete: session has reports.',
        'session_delete_blocked_consumption' => 'Cannot delete: session has a consumption row. Reverse it first.',
        'session_delete_blocked_earnings' => 'Cannot delete: session has teacher earnings.',
        'edit_cycle' => 'Edit cycle',
        'edit_cycle_modal_title' => 'Edit cycle #:number',
        'cycle_edit_conflicts' => 'Cannot save — your edits conflict with existing data. Fix the dependencies below first.',
        'cycle_edit_fix_first' => 'Resolve every conflict above (delete a future session, reverse a consumption row, etc.) and re-submit.',
        'cycle_edit_success' => 'Cycle updated.',
        'forbidden_fields' => 'Read-only fields',
        'forbidden_fields_hint' => 'Use the per-row actions on this page (reverse / promote / record consumption) or the existing pause/resume/cancel flows to change those.',
        'save_changes' => 'Save changes',
        ...
        'tab_extension_period' => 'Extension Period',
        ...
        'no_sessions_extension_period' => 'No sessions in the extension period.',
        'extension_active_until' => 'This subscription is extended until :date',
        'extension_paid_window_ended' => 'Paid period ended on :date',
    ...
    'recording' => [
        'page_title' => 'Recording & Monitoring Management',
        'page_subtitle' => 'Monitor and record sessions',
        'breadcrumb' => 'Recording Management',
        'system_on' => 'Recording ON',
        'system_off' => 'Recording OFF',
        'stop_all' => 'Stop All',
        'confirm_disable_system' => 'Disable auto-recording? No new sessions will be recorded.',
        'confirm_enable_system' => 'Enable auto-recording?',
        'confirm_stop_all' => 'Stop all active recordings now?',
        ...
        'capacity_server_status' => 'Server Status',
        'capacity_recorded_today' => 'Recorded Today',
        'server_healthy' => 'Healthy',
        'server_at_capacity' => 'At Capacity',
        'server_error' => 'Error',
        'tab_live' => 'Live Sessions',
        'tab_history' => 'History',
        'type_quran_individual' => 'Individual Quran',
        'type_quran_group' => 'Group Quran',
        'type_academic_lesson' => 'Academic Lesson',
        'type_interactive_course' => 'Interactive Course',
        'type_trial' => 'Trial Session',
        ...
        'status_completed' => 'Completed',
        'status_failed' => 'Failed',
        'status_none' => 'No Recording',
        'filter_session_type' => 'Session Type',
        'filter_recording_status' => 'Recording Status',
        'filter_all_types' => 'All Types',
        'filter_all_statuses' => 'All Statuses',
        'filter_teacher' => 'Teacher',
        'filter_all_teachers' => 'All Teachers',
        'filter_search' => 'Search...',
        'history_total_recorded' => 'Total Recorded',
        'history_total_skipped' => 'Total Skipped',
        'history_total_failed' => 'Total Failed',
        'history_total_duration' => 'Total Duration',
        'history_storage_used' => 'Storage Used',
        'observe_session' => 'Observe',
        'join_session' => 'Join',
        'no_live_sessions' => 'No Live Sessions',
        'no_live_sessions_description' => 'No live sessions within your permissions scope.',
        'no_history' => 'No History',
        'no_history_description' => 'No sessions have been recorded yet.',
        'session' => 'Session',
        'teacher' => 'Teacher',
        'type' => 'Type',
        'time' => 'Time',
        ...
        'deleted_success' => 'Recording deleted successfully',
        'bulk_selected' => 'Selected',
        'bulk_download' => 'Download All',
        'bulk_delete' => 'Delete All',
        'bulk_delete_title' => 'Delete Selected Recordings',
        'bulk_delete_confirm' => 'Are you sure you want to delete the selected recordings?',
        'bulk_deleted_success' => ':count recording(s) deleted successfully',
