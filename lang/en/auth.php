...
return [
    ...
    */
    ...
    'register' => [
        ...
        'parent' => [
            ...
            'step2' => [
                ...
                'password_helper' => 'Must contain at least 8 characters with uppercase, lowercase, and numbers',
        ...
        'teacher' => [
            ...
            'step2' => [
                ...
                'phone' => 'Phone Number',
                'phone_placeholder' => 'Enter phone number',
                'has_ijazah' => 'Do you have Quran Ijazah?',
                'has_ijazah_yes' => 'Yes, I have Quran Ijazah',
                'has_ijazah_no' => 'No, I don\'t have Ijazah',
                'ijazah_details' => 'Ijazah Details',
                'ijazah_details_placeholder' => 'Enter your Quran Ijazah details (Sheikh, chain of narration, date...)',
        ...
        'student' => [
            ...
            'password' => 'Password',
            'password_placeholder' => 'Enter password (at least 8 characters)',
            'password_helper' => 'Must contain at least 8 characters',
            'password_confirmation' => 'Confirm Password',
            'password_confirmation_placeholder' => 'Re-enter password',
            'submit' => 'Create Account',
            'already_have_account' => 'Already have an account?',
    ...
    'reset_password' => [
        ...
        'new_password_helper' => 'Password must be at least 8 characters',
        'confirm_password' => 'Confirm Password',
