...
return [
    ...
    */
    ...
    'messages' => [
        ...
        'email_not_verified' => 'Please verify your email address before joining the session. Check your inbox and click the verification link.',
        'session_not_found' => 'Session not found or has been deleted',
        'not_authorized' => 'You are not authorized to join this session',
    ...
    'system' => [
        ...
        'how_to_reset_title' => 'Reset Permissions',
        'modal_subtitle' => 'Camera or microphone was previously blocked. Follow these steps to re-enable.',
        'modal_got_it' => 'Got it',
        'how_to_reset_step1_title' => 'Open site settings',
        'how_to_reset_step1' => 'Click the lock 🔒 or settings icon in the address bar above',
        'how_to_reset_step2_title' => 'Change permissions',
        'how_to_reset_step2' => 'Find Camera and Microphone and change from "Block" to "Allow"',
        'how_to_reset_step3_title' => 'Reload the page',
        'how_to_reset_step3' => 'After changing the settings, reload the page to apply the changes',
        'allowed' => 'Allowed',
        'denied' => 'Denied',
    ...
    'connection' => [
        ...
        'mic_access_denied' => 'Microphone blocked — cannot participate with audio',
        'mic_blocked_chrome' => 'Click the lock/tune icon next to the URL → Site settings → Microphone → Allow, then reload the page.',
        'mic_blocked_safari' => 'Safari → Settings → Websites → Microphone → Allow for this site, then reload the page.',
        'mic_blocked_firefox' => 'Click the lock icon next to the URL → Clear microphone permission, then reload the page.',
        'mic_blocked_generic' => 'Open browser settings → Site permissions → Microphone → Allow for this site, then reload the page.',
        'mic_not_found_instructions' => 'No microphone detected. Please connect a microphone and reload the page.',
        'reload_page' => 'Reload',
