        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('courses.show', ['subdomain' => $academy->subdomain, 'id' => $course->id]) }}" 
                           class="mr-1 text-sm font-medium text-gray-700 hover:text-primary">
                            {{ $course->title }}
                        </a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="ri-arrow-left-s-line text-gray-400"></i>
                        <span class="mr-1 text-sm font-medium text-gray-500">{{ $lesson->title }}</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 border-t border-gray-200">
                        ...
                        <div class="text-center">
                            <div class="text-lg font-bold text-gray-900">{{ $lesson->order ?? $lesson->id }}</div>
                            <div class="text-sm text-gray-600">ترتيب الدرس</div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="text-lg font-bold text-gray-900">{{ $lesson->view_count ?? 0 }}</div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-shrink-0">
                                    @if($courseLesson->id === $lesson->id)
                                        <i class="ri-play-circle-fill text-primary"></i>
...
function markLessonCompleted(lessonId) {
    fetch(`/courses/{{ $course->id }}/lessons/${lessonId}/complete`, {
        ...
        toast.innerHTML = '<i class="ri-check-line ml-2"></i>تم إكمال الدرس بنجاح!';
