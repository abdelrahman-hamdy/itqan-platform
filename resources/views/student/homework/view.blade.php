<x-layouts.student title="{{ __('student.homework_submission.view_title') }}">
    <div class="space-y-4 md:space-y-6">
            ...
            <div class="space-y-4 md:space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                            ...
                            <div class="flex flex-wrap items-center gap-2 md:gap-3">
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                    ...
                                    <i class="{{ $homework['type'] === 'academic' ? 'ri-book-line' :
                                                 ...
                                                 'ri-presentation-line') }} ms-1"></i>
                                    {{ $homework['type'] === 'academic' ? __('student.homework_submission.type_academic') :
                                       ($homework['type'] === 'quran' ? __('student.homework_submission.type_quran') :
                                       __('student.homework_submission.type_interactive')) }}
                                </span>
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded text-sm font-medium bg-red-100 text-red-800">
                                    ...
                                    {{ __('student.homework_submission.status_late') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        @if($homework['score'] !== null)
                            <div class="text-center bg-gray-50 rounded-xl p-3 md:p-4 md:me-4 w-full md:w-auto">
                    ...
                    @if($homework['description'])
                        <div class="mt-4 p-3 md:p-4 bg-gray-50 rounded-xl">
                            <p class="text-sm font-medium text-gray-700 mb-2">{{ __('student.homework_submission.homework_description') }}</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        <div class="flex items-center">
                            <div class="bg-blue-100 rounded-full p-3 ms-3">
                                <i class="ri-calendar-line text-blue-600 text-xl"></i>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">{{ __('student.homework_submission.due_date_label') }}</p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        <div class="flex items-center">
                            <div class="bg-green-100 rounded-full p-3 ms-3">
                                <i class="ri-send-plane-line text-green-600 text-xl"></i>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">{{ __('student.homework_submission.submitted_label') }}</p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        <div class="flex items-center">
                            <div class="bg-purple-100 rounded-full p-3 ms-3">
                                <i class="ri-star-line text-purple-600 text-xl"></i>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">{{ __('student.homework_submission.graded_label') }}</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                    <h3 class="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4 flex items-center">
                        <i class="ri-file-text-line text-blue-600 ms-2"></i>
                        {{ __('student.homework_submission.student_answer') }}
                    </h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                    <h3 class="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4 flex items-center">
                        <i class="ri-attachment-line text-blue-600 ms-2"></i>
                        {{ __('student.homework_submission.attached_files') }}
                    </h3>
                        ...
                        @foreach($submission->submission_files as $file)
                            <a href="{{ Storage::url($file['path']) }}"
                               ...
                               class="flex items-center min-h-[56px] p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors group">
                                <div class="bg-blue-100 rounded-lg p-2 ms-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 truncate group-hover:text-blue-600">
                                        {{ $file['original_name'] ?? __('student.homework_submission.file_default_name') }}
                                    </p>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-200 p-4 md:p-6">
                    <h3 class="text-base md:text-lg font-semibold text-blue-900 mb-3 md:mb-4 flex items-center">
                        <i class="ri-feedback-line text-blue-600 ms-2"></i>
                        {{ __('student.homework_submission.teacher_feedback') }}
                    </h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                    <h3 class="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4 flex items-center">
                        <i class="ri-bar-chart-line text-purple-600 ms-2"></i>
                        {{ __('student.homework_submission.quality_assessment') }}
                    </h3>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                        @if($submission->content_quality_score)
                        <div class="text-center p-3 md:p-4 bg-purple-50 rounded-xl">
                            <p class="text-xs md:text-sm text-purple-700 mb-1">{{ __('student.homework_submission.content_quality') }}</p>
                        ...
                        <div class="text-center p-3 md:p-4 bg-blue-50 rounded-xl">
                            <p class="text-xs md:text-sm text-blue-700 mb-1">{{ __('student.homework_submission.presentation_quality') }}</p>
                        ...
                        <div class="text-center p-3 md:p-4 bg-green-50 rounded-xl">
                            <p class="text-xs md:text-sm text-green-700 mb-1">{{ __('student.homework_submission.effort_quality') }}</p>
        ...
        @else
            ...
            <div class="bg-red-50 border border-red-200 rounded-xl p-6 md:p-8 text-center">
                ...
                <h3 class="text-lg md:text-xl font-semibold text-red-900 mb-2">{{ __('student.homework_submission.error_loading_title') }}</h3>
