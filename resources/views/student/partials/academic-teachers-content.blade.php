  ...
  <div class="mb-4 flex justify-center">
    <div class="flex gap-1 bg-white rounded-xl p-1 border border-gray-200 shadow-sm">
      <a href="{{ route('academic-teachers.index', array_merge(request()->except(['gender', 'page']), ['subdomain' => $academy->subdomain, 'gender' => 'male'])) }}"
         class="{{ $activeGender === 'male' ? 'bg-violet-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100' }} px-5 py-2 rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-2">
        <img src="{{ asset('app-design-assets/male-academic-teacher-avatar.png') }}" alt="" class="w-6 h-6 rounded-full object-cover">
      ...
      <a href="{{ route('academic-teachers.index', array_merge(request()->except(['gender', 'page']), ['subdomain' => $academy->subdomain, 'gender' => 'female'])) }}"
         class="{{ $activeGender === 'female' ? 'bg-violet-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100' }} px-5 py-2 rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-2">
        <img src="{{ asset('app-design-assets/female-academic-teacher-avatar.png') }}" alt="" class="w-6 h-6 rounded-full object-cover">
