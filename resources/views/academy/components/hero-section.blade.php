...
<section id="main-content" class="relative min-h-screen flex items-center overflow-hidden" role="banner">
  ...
  <div class="absolute top-20 right-20 w-24 h-24 bg-gradient-to-br from-{{ $gradientFrom }}/10 to-transparent rounded-2xl rotate-12 animate-pulse"></div>
  <div class="absolute bottom-32 left-16 w-20 h-20 bg-gradient-to-br from-{{ $gradientTo }}/10 to-transparent rounded-2xl -rotate-12 animate-pulse" style="animation-delay: 1s;"></div>
  ...
  <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
    <div class="space-y-8">
        ...
        <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
          ...
          <span class="bg-gradient-to-r from-{{ $gradientFrom }} to-{{ $gradientTo }} bg-clip-text text-transparent">متميز</span>
