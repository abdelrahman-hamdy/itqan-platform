    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="text-center">
        ...
        <div class="stat-number">
          <span class="stats-counter" data-target="{{ $academy->stats_students ?? 15000 }}">0</span>
      ...
      <div class="text-center">
        ...
        <div class="stat-number">
          <span class="stats-counter" data-target="{{ $academy->stats_teachers ?? 500 }}">0</span>
          <span class="stat-suffix">+</span>
        </div>
      ...
      <div class="text-center">
        ...
        <div class="stat-number">
          <span class="stats-counter" data-target="{{ $academy->stats_courses ?? 1200 }}">0</span>
          <span class="stat-suffix">+</span>
        </div>
      ...
      <div class="text-center">
        ...
        <div class="stat-number">
          <span class="stats-counter" data-target="{{ $academy->stats_success_rate ?? 95 }}">0</span>
          <span class="stat-suffix">%</span>
        </div>
