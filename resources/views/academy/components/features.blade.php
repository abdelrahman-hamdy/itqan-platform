...
<section class="py-20 bg-primary text-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <h2 class="text-4xl font-bold mb-4">لماذا تختار {{ $academy->name ?? 'أكاديمية مَعِين' }}؟</h2>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="text-center">
        ...
        <h3 class="text-xl font-bold mb-3">جودة تعليمية عالية</h3>
        <p class="text-blue-100">محتوى تعليمي مراجع من قبل خبراء التعليم</p>
      </div>
      <div class="text-center">
        <div class="w-16 h-16 flex items-center justify-center bg-white/20 rounded-full mx-auto mb-4">
