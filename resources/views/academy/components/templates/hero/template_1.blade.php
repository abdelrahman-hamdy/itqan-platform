...
<!-- Modern Hero Section -->
<section id="hero-section" class="relative flex items-center justify-center overflow-hidden py-24 sm:py-16 lg:py-0" role="banner" style="min-height: min(100vh, 56rem);">
  ...
  <div class="absolute inset-0 z-[1]" style="background: linear-gradient(to bottom right, {{ $gradientFromHex }}15, rgba(255,255,255,0.75), {{ $gradientToHex }}15);"></div>
  <div class="absolute inset-0 z-[1]" style="background: radial-gradient(ellipse at center, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.35) 40%, transparent 70%);"></div>

  <!-- Side fade to white -->
  <div class="absolute inset-0 z-[2]" style="background: linear-gradient(to right, rgba(255,255,255,0.5) 0%, transparent 12%, transparent 88%, rgba(255,255,255,0.5) 100%);"></div>
  ...
  <img src="{{ asset('app-design-assets/landing-hero-right.png') }}"
       alt=""
       class="absolute pointer-events-none select-none z-[3] bottom-0 left-1/2 -translate-x-1/2 opacity-[0.8] max-w-[180px] sm:max-w-[220px] lg:left-auto lg:translate-x-0 lg:right-0 lg:opacity-100 lg:max-w-[350px]" />
  <img src="{{ asset('app-design-assets/landing-hero-left.png') }}"
       ...
       style="max-width: 850px; bottom: -150px;" />
