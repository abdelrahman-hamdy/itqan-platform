        ...
        <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-forms.phone-input
                            ...
                            :initialCountry="strtolower($supervisor->phone_country ?: (\App\Helpers\CountryList::dialCodeToIso($supervisor->phone_country_code) ?? ''))"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    @foreach(['can_manage_teachers', 'can_manage_students', 'can_confirm_student_emails', 'can_manage_parents', 'can_reset_passwords'] as $perm)
