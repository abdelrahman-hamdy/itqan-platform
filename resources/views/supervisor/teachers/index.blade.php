                        ...
                        <div class="flex items-start gap-3 md:gap-4 mb-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs md:text-sm text-gray-600">
                                    ...
                                    <span x-data="{ val: @js($teacher['user']->email) }" class="flex items-center gap-1 cursor-pointer hover:text-blue-600 transition-colors"
                            ...
                            <div x-show="expanded" x-collapse>
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    @if($isAdmin || $canManageTeachers)
                                        ...
                                        {{-- Edit Teacher --}}
                                        <a href="{{ route('manage.teachers.edit', ['subdomain' => $subdomain, 'teacher' => $teacherId]) }}"
                                           class="cursor-pointer inline-flex items-center gap-1.5 px-3 py-2 text-xs md:text-sm font-medium rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors">
                                        ...
                                        @if(!$teacher['user']->email_verified_at)
                                            <form id="verify-email-form-{{ $teacherId }}" method="POST"
                                                  action="{{ route('manage.teachers.verify-email', ['subdomain' => $subdomain, 'teacher' => $teacherId]) }}">
                                                @csrf
                                            </form>
                                            <button type="button"
                                                onclick="window.confirmAction({
                                                    ...
                                                    onConfirm: () => document.getElementById('verify-email-form-{{ $teacherId }}').submit()
                                                })"
