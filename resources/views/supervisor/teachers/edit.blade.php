                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-forms.phone-input
                            ...
                            :initialCountry="strtolower($teacher->phone_country ?: (\App\Helpers\CountryList::dialCodeToIso($teacher->phone_country_code) ?? ''))"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="university" class="block text-sm font-medium text-gray-700 mb-1">
                            {{ __('auth.register.teacher.step2.university') }}
                        </label>
                        <input type="text" name="university" id="university" value="{{ old('university', $isQuran ? ($profile?->university ?? $teacher->university) : $profile?->university) }}"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                        @foreach(\App\Enums\SessionDuration::cases() as $duration)
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">{{ getTeacherEarningsCurrencySymbol($teacher->academy ?? null) }}</span>
