...
<div>
    ...
    <x-ui.breadcrumb
        :items="[
            ['label' => __('supervisor.quizzes.breadcrumb'), 'route' => route('supervisor.quizzes.index', ['subdomain' => $subdomain])],
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div class="lg:col-span-1 space-y-4 md:space-y-6">
            ...
            <a href="{{ route('supervisor.quizzes.index', ['subdomain' => $subdomain]) }}"
