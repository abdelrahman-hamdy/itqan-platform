        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-4">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-lg md:text-xl font-bold text-gray-900">{{ number_format($stats['totalEarnings'], 2) }}</p>
        ...
        <div x-data="{ open: {{ $hasActiveFilters ? 'true' : 'false' }} }" class="border-b border-gray-200">
            ...
            <div x-show="open" x-collapse>
                <form method="GET" action="{{ route('manage.teacher-earnings.index', ['subdomain' => $subdomain]) }}" class="px-4 md:px-6 pb-4">
                    ...
                    <p class="text-xs text-gray-400 mt-2">{{ __('supervisor.teacher_earnings.cycle_definition_hint') }}</p>
                    <p class="text-xs text-gray-400 mt-1">{{ __('supervisor.teacher_earnings.date_range_hint') }}</p>
