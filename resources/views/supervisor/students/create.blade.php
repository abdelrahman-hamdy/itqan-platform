...
<div>
    <x-ui.breadcrumb
        :items="[
            ...
            ['label' => __('supervisor.students.add_student')],
        ]"
    ...
    <div class="mb-6 md:mb-8">
        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">{{ __('supervisor.students.create_title') }}</h1>
        <p class="mt-1 md:mt-2 text-sm md:text-base text-gray-600">{{ __('supervisor.students.create_subtitle') }}</p>
    </div>
    ...
    <form method="POST"
          action="{{ route('manage.students.store', ['subdomain' => $subdomain]) }}"
        ...
        <div class="max-w-3xl mx-auto space-y-6">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div class="relative inline-block">
                            <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg ring-2 ring-primary/20 relative"
                                ...
                                <!-- Default avatar (dynamic based on gender) -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="gender" id="gender" required x-model="gender"
                            ...
                            <option value="male">{{ __('supervisor.students.male_student') }}</option>
                            <option value="female">{{ __('supervisor.students.female_student') }}</option>
                        </select>
                        @error('gender')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">{{ __('supervisor.students.security_info') }}</h3>
                </div>
