    ...
    <div @click.stop
        ...
        <div class="p-6 pb-4">
            ...
            <div class="mx-auto flex items-center justify-center w-16 h-16 rounded-full mb-4"
                ...
                <svg x-show="!isDangerous" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-8 h-8 text-blue-600 dark:text-blue-400">
