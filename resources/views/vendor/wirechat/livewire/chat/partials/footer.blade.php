...
<footer class="shrink-0 h-auto relative   sticky bottom-0 mt-auto">
    ...
    @if ($conversation->isGroup() && !$conversation->group?->allowsMembersToSendMessages() && !$authParticipant->isAdmin())
        <div
            class="bg-gray-50 dark:bg-gray-800 w-full text-center text-gray-600 dark:text-gray-200 justify-center text-sm flex py-4 ">
            Only admins can send messages
        </div>
    @else
        <div id="chat-footer" x-data="{ 'openEmojiPicker': false }"
            class=" px-3 md:px-1 border-t shadow-sm bg-white dark:bg-gray-800 z-50 border-gray-200 dark:border-gray-700 flex flex-col gap-3 items-center  w-full   mx-auto">
            ...
            <section wire:ignore x-cloak x-show="openEmojiPicker" x-transition:enter="transition  ease-out duration-180 transform"
                ...
                class="w-full flex hidden sm:flex   py-2 sm:px-4 py-1.5 border-b border-gray-200 dark:border-gray-700  h-96 min-w-full">
            ...
            <section
                class=" py-2 sm:px-4 py-1.5    z-50  bg-white dark:bg-gray-800   flex flex-col gap-3 items-center  w-full mx-auto">
                        ...
                        <div x-data="attachments('media')">
                            ...
                            <section
                                ...
                                <label wire:loading.class="cursor-progress"
                                    class="shrink-0 cursor-pointer relative w-16 h-14 rounded-lg  bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700  flex text-center justify-center transition-colors duration-200">
                        ...
                        <section x-data="attachments('files')"
                            ...
                            @foreach ($files as $key => $file)
                                <div class="relative shrink-0">
                                    ...
                                    {{-- File details --}}
                                    <div
                                        class="flex items-center group overflow-hidden bg-white dark:bg-gray-900 hover:border-gray-300 dark:hover:border-gray-600 border border-gray-200 dark:border-gray-700 rounded-xl transition-colors duration-200">
                                        <span class=" p-2">
                                            {{-- document svg:HI --}}
                            ...
                            <label wire:loading.class="cursor-progress"
                                class="cursor-pointer shrink-0 relative w-16 h-14 rounded-lg bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-colors duration-200 flex text-center justify-center  ">
                                <input wire:loading.attr="disabled"
                ...
                document.querySelector('emoji-picker')
                    ...
                    <div class="w-10 hidden sm:flex max-w-fit  items-center">
                        <button wire:loading.attr="disabled" type="button" dusk="emoji-trigger-button"
                            ...
                            <svg x-bind:class="openEmojiPicker && 'text-primary-500'"
                                viewBox="0 0 24 24" height="24" width="24"
                                preserveAspectRatio="xMidYMid meet"
                                class="w-7 h-7 text-gray-600 dark:text-gray-300 srtoke-[1.3] dark:stroke-[1.2] transition-colors duration-200"
                    ...
                    <div x-cloak @class(['w-[5%] justify-end min-w-max  items-center gap-2 '])>
                        ...
                        <button
                            ...
                            id="sendMessageButton" class="cursor-pointer hover:text-primary-500 transition-colors duration-200 ml-auto disabled:cursor-progress cursor-pointer font-bold">
