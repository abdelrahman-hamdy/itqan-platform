...
<main x-data="{
    ...
    style="contain: content; background-color: #f0f4f8; background-image: url('{{ asset('app-design-assets/chat-bg-pattern.png') }}'); background-repeat: repeat; background-size: 400px;" >
