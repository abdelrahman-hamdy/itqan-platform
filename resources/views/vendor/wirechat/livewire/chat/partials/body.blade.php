...
<main x-data="{
    ...
    <div class="absolute inset-0 pointer-events-none" style="background-image: url('{{ asset('app-design-assets/new-chat-bg-pattern2.png') }}'); background-repeat: repeat; background-size: 300px; opacity: 0.3;"></div>
