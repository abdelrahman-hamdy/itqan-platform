...
<main x-data="{
    ...
    <div class="absolute inset-0 pointer-events-none" style="background-image: url('{{ asset('app-design-assets/new-chat-bg-seamless-pattern.png') }}'); background-repeat: repeat; background-size: 1250px; opacity: 0.07;"></div>
