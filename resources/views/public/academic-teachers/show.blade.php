<x-layouts.student
  ...
  <nav class="mb-6">
    <ol class="flex items-center space-x-2 space-x-reverse text-sm text-gray-500">
      ...
      <li>/</li>
      <li><a href="{{ route('student.academic-teachers', ['subdomain' => auth()->user()->academy->subdomain ?? 'itqan-academy']) }}" class="hover:text-gray-900">المعلمون الأكاديميون</a></li>
      <li>/</li>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($packages as $package)
          <x-teacher.package-card
            ...
            :academy="$academy"
            color="violet"
            :subscribe-route="route('public.academic-packages.subscribe', ['subdomain' => auth()->user()->academy->subdomain ?? $academy->subdomain, 'teacher' => $teacher->id, 'packageId' => $package->id])"
