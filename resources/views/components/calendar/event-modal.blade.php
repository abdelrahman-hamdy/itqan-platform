...
<div id="event-modal" class="modal-overlay" x-data @click="closeModal($event)" role="dialog" aria-modal="true" aria-labelledby="modal-title">
    <div class="modal-content" @click.stop>
        ...
        <div id="modal-header" class="relative bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-t-xl">
            <button @click="closeModal()" class="absolute top-4 rtl:left-4 ltr:right-4 text-white/80 hover:text-white transition-colors p-2 hover:bg-white/10 rounded-lg" aria-label="{{ __('student.calendar.modal.close') }}">
                <i class="ri-close-line text-2xl" aria-hidden="true"></i>
            </button>
            <div class="rtl:pr-12 ltr:pl-12">
                <!-- Status Badge -->
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="bg-blue-50 border border-blue-100 rounded-lg p-4">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-xs font-semibold text-blue-600 uppercase">{{ __('student.calendar.modal.date_label') }}</span>
                    </div>
                ...
                <div class="bg-green-50 border border-green-100 rounded-lg p-4">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-xs font-semibold text-green-600 uppercase">{{ __('student.calendar.modal.time_label') }}</span>
                    </div>
            ...
            <div class="bg-purple-50 border border-purple-100 rounded-lg p-4 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-semibold text-purple-600 uppercase">{{ __('student.calendar.modal.duration_label') }}</span>
                    </div>
            ...
            <div id="modal-teacher-container" class="mb-6 hidden">
                <h4 class="text-xs font-semibold text-gray-500 uppercase mb-3">{{ __('student.calendar.modal.teacher_label') }}</h4>
                <div id="modal-teacher" class="flex items-center gap-3 p-4 bg-gradient-to-r rtl:from-orange-50 rtl:to-orange-100/50 ltr:from-orange-100/50 ltr:to-orange-50 border border-orange-200 rounded-lg"></div>
            </div>

            <!-- Description -->
            <div id="modal-description-container" class="mb-6 hidden">
                <h4 class="text-xs font-semibold text-gray-500 uppercase mb-3">{{ __('student.calendar.modal.description_label') }}</h4>
            ...
            <div id="modal-participants-container" class="mb-6 hidden">
                <h4 class="text-xs font-semibold text-gray-500 uppercase mb-3">{{ __('student.calendar.modal.participants_label') }}</h4>
            ...
            <a id="modal-view-button" href="#" class="block w-full text-center px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                <i class="ri-external-link-line text-lg me-2"></i>
                <span>{{ __('student.calendar.modal.view_session') }}</span>
            </a>
        </div>
    </div>
</div>
