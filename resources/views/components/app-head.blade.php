...
window.arabicCountryNames = {
    ...
    'sd': 'السودان', 'sy': 'سوريا', 'ma': 'المغرب', 'dz': 'الجزائر',
    'tn': 'تونس', 'ly': 'ليبيا', 'mr': 'موريتانيا', 'so': 'الصومال',
    'dj': 'جيبوتي', 'km': 'جزر القمر', 'us': 'الولايات المتحدة',
    'gb': 'المملكة المتحدة', 'ca': 'كندا', 'au': 'أستراليا',
    'de': 'ألمانيا', 'fr': 'فرنسا', 'it': 'إيطاليا', 'es': 'إسبانيا',
    'tr': 'تركيا', 'pk': 'باكستان', 'in': 'الهند', 'bd': 'بنغلاديش',
    'my': 'ماليزيا', 'id': 'إندونيسيا',
};
window.phoneFormats = {
