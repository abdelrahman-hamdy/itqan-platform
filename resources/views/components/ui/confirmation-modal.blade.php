    ...
    <div
        ...
        <div class="p-6 pb-4">
            ...
            <div class="mx-auto flex items-center justify-center w-16 h-16 rounded-full mb-4"
                ...
                <template x-if="icon">
                    <i :class="icon" class="text-3xl" :class="isDangerous ? 'text-red-600' : 'text-blue-600'"></i>
                </template>
            ...
            {{-- Message --}}
            <p class="text-center text-gray-600 text-sm leading-relaxed" x-text="message"></p>
        </div>
        ...
        <div class="bg-gray-50 px-6 py-4 flex gap-3 justify-end">
            ...
            <button
                @click="close()"
                type="button"
                class="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-white hover:bg-gray-100 border border-gray-300 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400">
