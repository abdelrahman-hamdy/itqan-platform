...
<body class="bg-gray-50 text-gray-900">
  ...
  <button id="sidebar-toggle-mobile"
          class="fixed bottom-6 right-6 md:hidden bg-primary text-white p-4 rounded-full shadow-lg z-50 min-h-[56px] min-w-[56px] flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
