            ...
            @switch($item['type'])
                ...
                @case('individual_circle')
                    ...
                    @if(isset($item['meta']['monthly_fee']) && $item['meta']['monthly_fee'])
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span>{{ $item['meta']['monthly_fee'] }} {{ getCurrencySymbol() }} / {{ __('common.units.per_month') }}</span>
                        </div>
                    @endif
                ...
                @case('academic_session')
                    @if(isset($item['meta']['subject']) && $item['meta']['subject'])
                        <div class="flex items-center text-sm text-gray-600">
                            <i class="ri-bookmark-line ms-2"></i>
                ...
                @case('recorded_course')
                    ...
                    @if(isset($item['meta']['lessons_count']) && $item['meta']['lessons_count'])
                        <div class="flex items-center text-sm text-gray-600">
                            <i class="ri-play-list-line ms-2"></i>
                ...
                @case('academic_teacher')
                    ...
                    @if(isset($item['meta']['hourly_rate']) && $item['meta']['hourly_rate'])
                        <div class="flex items-center text-sm text-gray-600">
                            <i class="ri-money-dollar-circle-line ms-2"></i>
                            <span>{{ $item['meta']['hourly_rate'] }} {{ getCurrencySymbol() }} / {{ __('common.units.per_hour') }}</span>
                        </div>
                    @endif
    ...
    <div class="mt-4 pt-3 border-t border-gray-100">
        <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">
                @if($item['is_enrolled'])
                    <i class="ri-arrow-left-s-line ms-1"></i>
                    متابعة
                @else
                    <i class="ri-arrow-left-s-line ms-1"></i>
                    عرض التفاصيل
