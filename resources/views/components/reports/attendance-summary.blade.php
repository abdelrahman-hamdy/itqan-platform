...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
        <i class="ri-calendar-check-line text-{{ $colorClass }}-600 ml-2"></i>
        {{ $title }}
    </h2>
