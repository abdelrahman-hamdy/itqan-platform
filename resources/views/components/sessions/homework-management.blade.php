...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-semibold text-gray-900">إدارة الواجبات المنزلية</h3>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="bg-gray-50 border-b border-gray-200 p-6 rounded-t-xl">
                <div class="flex items-center gap-3">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900">واجب الجلسة</h4>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="grid gap-4 mb-6 @if($homeworkCount == 1) grid-cols-1 @elseif($homeworkCount == 2) grid-cols-1 md:grid-cols-2 @else grid-cols-1 md:grid-cols-2 lg:grid-cols-3 @endif">
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-5 border border-green-200 shadow-sm hover:shadow-md transition-all duration-200 h-full">
                        <div class="flex items-center mb-3">
                            ...
                            <span class="text-sm text-green-700 font-semibold">حفظ جديد</span>
                        </div>
                        ...
                        <p class="text-green-700 text-sm font-medium">{{ $session->sessionHomework->new_memorization_pages }} وجه</p>
                        @endif
                    </div>
                    @endif
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-200 shadow-sm hover:shadow-md transition-all duration-200 h-full">
                        <div class="flex items-center mb-3">
                            ...
                            <span class="text-sm text-blue-700 font-semibold">مراجعة</span>
                        </div>
                        ...
                        <p class="text-blue-700 text-sm font-medium">{{ $session->sessionHomework->review_pages }} وجه</p>
                        @endif
                    </div>
                    @endif
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-5 border border-purple-200 shadow-sm hover:shadow-md transition-all duration-200 h-full">
                        <div class="flex items-center mb-3">
                            ...
                            <span class="text-sm text-purple-700 font-semibold">مراجعة شاملة</span>
                        </div>
                ...
                <div class="border-t border-gray-200 pt-6 mt-6">
                    <div class="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-5 border border-amber-200 shadow-sm">
                        <div class="flex items-center mb-3">
                            <div class="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center ml-3">
                                <i class="ri-information-line text-amber-600 text-lg"></i>
                            </div>
                            <h5 class="font-semibold text-amber-900">تعليمات إضافية</h5>
                        </div>
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-medium text-gray-900 mb-2">لا يوجد واجب محدد</h3>
            <p class="text-gray-600 mb-4">لم يتم تحديد واجب منزلي لهذه الجلسة بعد.</p>
        </div>
    @endif
</div>
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">إضافة واجب جديد</h3>
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                <h4 class="text-lg font-semibold text-gray-900">نوع الواجب</h4>
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center mb-3">
                        ...
                        <label for="has_new_memorization" class="mr-2 text-sm font-medium text-gray-900">
                            حفظ جديد
                        </label>
                    </div>
                    ...
                    <div id="newMemorizationFields" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                        <div>
                            <label for="new_memorization_surah" class="block text-sm font-medium text-gray-700 mb-1">السورة</label>
                        ...
                        <div>
                            <label for="new_memorization_pages" class="block text-sm font-medium text-gray-700 mb-1">عدد الأوجه</label>
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center mb-3">
                        <input type="checkbox" id="has_review" name="has_review" 
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="has_review" class="mr-2 text-sm font-medium text-gray-900">
                            مراجعة
                        </label>
                    </div>
                    ...
                    <div id="reviewFields" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                        <div>
                            <label for="review_surah" class="block text-sm font-medium text-gray-700 mb-1">السورة</label>
                        ...
                        <div>
                            <label for="review_pages" class="block text-sm font-medium text-gray-700 mb-1">عدد الأوجه</label>
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center mb-3">
                        <input type="checkbox" id="has_comprehensive_review" name="has_comprehensive_review" 
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="has_comprehensive_review" class="mr-2 text-sm font-medium text-gray-900">
                            مراجعة شاملة
                        </label>
                    </div>
                    
                    <div id="comprehensiveReviewFields" class="hidden">
                        <label for="comprehensive_review_surahs" class="block text-sm font-medium text-gray-700 mb-1">السور</label>
                        ...
                        <p class="text-xs text-gray-500 mt-1">اختر السور المطلوب مراجعتها بشكل شامل</p>
                    </div>
                </div>
            </div>
            ...
            <div>
                <label for="additional_instructions" class="block text-sm font-medium text-gray-700 mb-1">تعليمات إضافية</label>
                <textarea id="additional_instructions" name="additional_instructions" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="أي تعليمات أو ملاحظات إضافية للطلاب"></textarea>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form?.addEventListener('submit', async function(e) {
        ...
        if (!data.has_new_memorization && !data.has_review && !data.has_comprehensive_review) {
            showNotification('يجب اختيار نوع واحد على الأقل من الواجبات', 'error');
            return;
        }
