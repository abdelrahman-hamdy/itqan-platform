...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-gray-900 flex items-center">
            <i class="ri-user-check-line text-{{ $attendanceColor }}-600 ml-2"></i>
    ...
    <div class="grid grid-cols-1 gap-4 mb-6">
        ...
        <div class="bg-{{ $attendanceColor }}-50 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-{{ $attendanceColor }}-800">معدل الحضور الإجمالي</p>
    ...
    <div class="space-y-3">
        <h4 class="text-sm font-semibold text-gray-700 flex items-center">
            <i class="ri-calendar-check-line text-gray-500 ml-1"></i>
            آخر سجلات الحضور
        </h4>
    ...
    <div class="mt-6 pt-4 border-t border-gray-200">
        <h4 class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
            <i class="ri-line-chart-line text-gray-500 ml-1"></i>
            اتجاهات الحضور
        </h4>
        ...
        <div class="space-y-2">
            <!-- This Week -->
            <div class="flex items-center justify-between">
                <span class="text-xs text-gray-600">هذا الأسبوع</span>
            ...
            <!-- Last Week -->
            <div class="flex items-center justify-between">
                <span class="text-xs text-gray-600">الأسبوع الماضي</span>
                <div class="flex items-center">
                    <div class="w-20 bg-gray-200 rounded-full h-2 ml-2">
            ...
            <!-- This Month -->
            <div class="flex items-center justify-between">
                <span class="text-xs text-gray-600">هذا الشهر</span>
                <div class="flex items-center">
                    <div class="w-20 bg-gray-200 rounded-full h-2 ml-2">
    ...
    <div class="mt-6 pt-4 border-t border-gray-200">
        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
            <div class="flex items-center">
                <i class="ri-target-line text-blue-600 ml-2"></i>
                <div>
                    <div class="text-sm font-medium text-blue-800">الهدف الشهري</div>
                    <div class="text-xs text-blue-600">الحفاظ على معدل حضور 90%</div>
                </div>
            </div>
            <div class="text-right">
                <div class="text-sm font-bold text-blue-600">{{ number_format($attendanceRate, 1) }}%</div>
                <div class="text-xs text-blue-500">
                    {{ $attendanceRate >= 90 ? '✓ تم تحقيق الهدف' : 'يحتاج تحسين' }}
                </div>
            </div>
        </div>
    </div>
