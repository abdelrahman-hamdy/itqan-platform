    ...
    <div class="chat-main flex flex-col">
      ...
      <div id="active-chat" class="hidden flex flex-col h-full">
        ...
        <div class="chat-messages-container relative" id="messages-container">
          ...
          <div class="absolute inset-0 opacity-15 z-0" style="background-image: url('/app-design-assets/chat-bg-pattern.png'); background-repeat: repeat; background-size: 200px;"></div>
