      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <x-forms.phone-input
              ...
              :initialCountry="strtolower($parent?->phone_country ?: (\App\Helpers\CountryList::dialCodeToIso($parent?->phone_country_code) ?? ''))"
              :value="$parent?->phone ?? ''"
        ...
        <div>
          <x-forms.phone-input
              ...
              :initialCountry="strtolower($parent?->secondary_phone_country ?: (\App\Helpers\CountryList::dialCodeToIso($parent?->secondary_phone_country_code) ?? ''))"
