...
<x-layouts.parent-layout title="التقارير">
    <div class="space-y-6">
        ...
        <div class="mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 flex items-center">
                    <i class="ri-bar-chart-line text-teal-600 ml-3"></i>
                    تقارير الأبناء
                </h1>
                <p class="text-gray-600 mt-2">متابعة تقدم أبنائك وحضورهم في جميع البرامج</p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900">تفاصيل اشتراكات الأبناء</h2>
                <p class="text-sm text-gray-500">عرض التقدم والأداء لكل اشتراك على حدة</p>
            </div>
        </div>
        ...
        @if(empty($childrenData))
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">لا توجد اشتراكات</h3>
                <p class="text-gray-500">لم يتم تسجيل أي اشتراكات لأبنائك حتى الآن</p>
            </div>
        @else
