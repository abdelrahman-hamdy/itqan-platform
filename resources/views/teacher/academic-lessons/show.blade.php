...
<div>
    ...
    <x-ui.breadcrumb
        :items="[
            ['label' => 'الدروس الخاصة', 'route' => route('teacher.academic.lessons.index', ['subdomain' => auth()->user()->academy->subdomain ?? 'itqan-academy'])],
            ['label' => $subscription->student->name ?? 'طالب', 'truncate' => true],
        ]"
        view-type="teacher"
    />
