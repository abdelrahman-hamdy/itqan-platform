...
@php
    ...
    // Map assignable_type class names to short keys for display
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 mb-4 md:mb-6">
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                <a href="{{ route('teacher.quizzes.edit', ['subdomain' => $subdomain, 'quiz' => $quiz->id]) }}"
    ...
    {{-- Assignments Section --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6" x-data="assignmentForm()">
