        ...
        <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mt-0.5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            <svg class="h-5 w-5 text-blue-500 mt-0.5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <div>
