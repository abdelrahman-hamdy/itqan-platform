<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @if($this->hasSelectedTeacher())
            ...
            <div class="mb-6 rounded-xl bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-950 dark:to-primary-900 px-6 py-7 shadow-md border-2 border-primary-200 dark:border-primary-800" wire:poll.60s>
