...
@section('content')
    <!-- Hero Section -->
    <div data-hero class="relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-800 via-cyan-600 to-teal-700 py-20 pt-40" style="min-height: 100vh;">
        ...
        <div class="absolute top-0 right-0 w-[40rem] h-[40rem] bg-gradient-to-br from-cyan-400/25 via-cyan-500/35 to-teal-500/30 rounded-full blur-3xl opacity-60"></div>
        <div class="absolute bottom-0 left-0 w-[45rem] h-[45rem] bg-gradient-to-tr from-turquoise-400/25 via-teal-500/30 to-cyan-500/25 rounded-full blur-3xl opacity-55"></div>
        <div class="absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 w-[35rem] h-[35rem] bg-gradient-to-l from-teal-400/25 via-cyan-500/30 to-turquoise-500/25 rounded-full blur-3xl opacity-50"></div>
        <div class="absolute top-0 left-0 w-[38rem] h-[38rem] bg-gradient-to-br from-cyan-400/25 via-teal-500/30 to-turquoise-500/25 rounded-full blur-3xl opacity-45"></div>
        <div class="absolute bottom-0 right-0 w-[42rem] h-[42rem] bg-gradient-to-tl from-turquoise-400/25 via-cyan-500/30 to-teal-500/25 rounded-full blur-3xl opacity-50"></div>

        <!-- Additional subtle elements -->
        <div class="absolute top-1/4 left-1/4 w-[20rem] h-[20rem] bg-gradient-to-r from-cyan-400/20 to-teal-500/25 rounded-full blur-2xl opacity-30"></div>
        <div class="absolute bottom-1/4 right-1/4 w-[25rem] h-[25rem] bg-gradient-to-r from-turquoise-400/20 to-cyan-500/25 rounded-full blur-2xl opacity-25"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mb-8" data-aos="fade-up">
                <span class="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-3 bg-white/10 text-cyan-100 rounded-full text-xs md:text-sm font-semibold border border-white/30 backdrop-blur-sm">
                    <i class="ri-folder-open-line text-base md:text-lg"></i>
                    معرض الأعمال
                </span>
            </div>
