...
@section('content')
    <!-- Hero Section -->
    <div data-hero class="relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-800 via-emerald-600 to-teal-700 py-20 pt-40" style="min-height: 100vh;">
