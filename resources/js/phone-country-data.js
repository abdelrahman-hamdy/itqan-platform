/**
 * Arabic Country Names for intl-tel-input
 *
 * Single source of truth for Arabic-localized country names.
 * Used by both app-head.blade.php (Alpine phone input) and
 * phone-input.blade.php (standalone component).
 *
 * Imported in phone-input.js and exposed as window.phoneCountryNamesAr.
 * Consumed via localizedCountries option when document lang is 'ar'.
 */

export const countryNamesAr = {
    // Arab countries
...
/**
 * Get localized country names based on the current page locale.
 * Returns Arabic names when lang="ar", undefined otherwise (intl-tel-input defaults to English).
 */
